...
#include <webkit/native/stlport/string>
#include <webkit/native/stlport/vector>
...
class HttpUtil {
 public:
  ...
  class HeadersIterator {
   ...
   private:
    StringTokenizerT<std::string, std::string::const_iterator> lines_;
  ...
  class ValuesIterator {
   ...
   private:
    StringTokenizerT<std::string, std::string::const_iterator> values_;
