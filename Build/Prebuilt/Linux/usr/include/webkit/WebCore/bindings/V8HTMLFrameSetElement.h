...
public:
    ...
    static HTMLFrameSetElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLFrameSetElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLFrameSetElement*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLFrameSetElement*);
};
...
v8::Handle<v8::Object> V8HTMLFrameSetElement::wrap(HTMLFrameSetElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLFrameSetElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLFrameSetElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLFrameSetElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLFrameSetElement > impl)
{
