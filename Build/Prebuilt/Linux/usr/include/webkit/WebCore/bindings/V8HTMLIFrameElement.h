...
public:
    ...
    static HTMLIFrameElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLIFrameElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLIFrameElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLIFrameElement*);
};
...
v8::Handle<v8::Object> V8HTMLIFrameElement::wrap(HTMLIFrameElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLIFrameElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLIFrameElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLIFrameElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLIFrameElement > impl)
{
