...
public:
    ...
    static DocumentType* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<DocumentType*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(DocumentType*, bool forceNewObject = false);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(DocumentType*);
};
...
v8::Handle<v8::Object> V8DocumentType::wrap(DocumentType* impl, bool forceNewObject)
{
    ...
    return V8DocumentType::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(DocumentType* impl, bool forceNewObject = false)
{
    if (!impl)
        return v8::Null();
    return V8DocumentType::wrap(impl, forceNewObject);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< DocumentType > impl, bool forceNewObject = false)
{
