...
public:
    ...
    static DOMStringMap* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<DOMStringMap*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(DOMStringMap*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(DOMStringMap*);
};
...
v8::Handle<v8::Object> V8DOMStringMap::wrap(DOMStringMap* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8DOMStringMap::wrapSlow(impl);
}

v8::Handle<v8::Value> toV8(DOMStringMap*);
inline v8::Handle<v8::Value> toV8(PassRefPtr< DOMStringMap > impl)
{
