...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(HTMLAppletElement*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLAppletElement*);
};
...
v8::Handle<v8::Object> V8HTMLAppletElement::wrap(HTMLAppletElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLAppletElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLAppletElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLAppletElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLAppletElement > impl)
{
