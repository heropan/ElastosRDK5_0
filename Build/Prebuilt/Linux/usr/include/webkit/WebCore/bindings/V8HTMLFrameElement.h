...
public:
    ...
    static HTMLFrameElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLFrameElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLFrameElement*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLFrameElement*);
};
...
v8::Handle<v8::Object> V8HTMLFrameElement::wrap(HTMLFrameElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLFrameElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLFrameElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLFrameElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLFrameElement > impl)
{
