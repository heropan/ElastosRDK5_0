...
public:
    ...
    static HTMLAnchorElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLAnchorElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLAnchorElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLAnchorElement*);
};
...
v8::Handle<v8::Object> V8HTMLAnchorElement::wrap(HTMLAnchorElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLAnchorElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLAnchorElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLAnchorElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLAnchorElement > impl)
{
