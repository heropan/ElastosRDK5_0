...
public:
    ...
    static HTMLFieldSetElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLFieldSetElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLFieldSetElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLFieldSetElement*);
};
...
v8::Handle<v8::Object> V8HTMLFieldSetElement::wrap(HTMLFieldSetElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLFieldSetElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLFieldSetElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLFieldSetElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLFieldSetElement > impl)
{
