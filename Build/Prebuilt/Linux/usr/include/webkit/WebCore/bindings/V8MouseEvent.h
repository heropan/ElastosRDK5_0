...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(MouseEvent*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 0;
private:
    static v8::Handle<v8::Object> wrapSlow(MouseEvent*);
};
...
v8::Handle<v8::Object> V8MouseEvent::wrap(MouseEvent* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8MouseEvent::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(MouseEvent* impl)
{
    if (!impl)
        return v8::Null();
    return V8MouseEvent::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< MouseEvent > impl)
{
