...
public:
    ...
    static HTMLTableSectionElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLTableSectionElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLTableSectionElement*, bool forceNewObject = false);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLTableSectionElement*);
};
...
v8::Handle<v8::Object> V8HTMLTableSectionElement::wrap(HTMLTableSectionElement* impl, bool forceNewObject)
{
    ...
    return V8HTMLTableSectionElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLTableSectionElement* impl, bool forceNewObject = false)
{
    if (!impl)
        return v8::Null();
    return V8HTMLTableSectionElement::wrap(impl, forceNewObject);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLTableSectionElement > impl, bool forceNewObject = false)
{
