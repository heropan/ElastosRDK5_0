...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(XSLTProcessor*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(XSLTProcessor*);
};
...
v8::Handle<v8::Object> V8XSLTProcessor::wrap(XSLTProcessor* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8XSLTProcessor::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(XSLTProcessor* impl)
{
    if (!impl)
        return v8::Null();
    return V8XSLTProcessor::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< XSLTProcessor > impl)
{
