...
public:
    ...
    static HTMLBodyElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLBodyElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLBodyElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLBodyElement*);
};
...
v8::Handle<v8::Object> V8HTMLBodyElement::wrap(HTMLBodyElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLBodyElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLBodyElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLBodyElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLBodyElement > impl)
{
