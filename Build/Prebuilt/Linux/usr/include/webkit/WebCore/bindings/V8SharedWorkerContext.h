...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(SharedWorkerContext*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(SharedWorkerContext*);
};
...
v8::Handle<v8::Object> V8SharedWorkerContext::wrap(SharedWorkerContext* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8SharedWorkerContext::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(SharedWorkerContext* impl)
{
    if (!impl)
        return v8::Null();
    return V8SharedWorkerContext::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< SharedWorkerContext > impl)
{
