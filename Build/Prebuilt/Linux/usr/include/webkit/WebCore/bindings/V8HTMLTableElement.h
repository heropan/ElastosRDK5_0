...
public:
    ...
    static HTMLTableElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLTableElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLTableElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLTableElement*);
};
...
v8::Handle<v8::Object> V8HTMLTableElement::wrap(HTMLTableElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLTableElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLTableElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLTableElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLTableElement > impl)
{
