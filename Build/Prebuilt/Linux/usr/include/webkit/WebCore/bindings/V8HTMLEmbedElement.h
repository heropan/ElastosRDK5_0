...
public:
    ...
    static HTMLEmbedElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLEmbedElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLEmbedElement*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLEmbedElement*);
};
...
v8::Handle<v8::Object> V8HTMLEmbedElement::wrap(HTMLEmbedElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLEmbedElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLEmbedElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLEmbedElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLEmbedElement > impl)
{
