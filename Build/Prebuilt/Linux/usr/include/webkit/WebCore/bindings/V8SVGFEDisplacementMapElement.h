...
public:
    ...
    static SVGFEDisplacementMapElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<SVGFEDisplacementMapElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(SVGFEDisplacementMapElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(SVGFEDisplacementMapElement*);
};
...
v8::Handle<v8::Object> V8SVGFEDisplacementMapElement::wrap(SVGFEDisplacementMapElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8SVGFEDisplacementMapElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(SVGFEDisplacementMapElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8SVGFEDisplacementMapElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< SVGFEDisplacementMapElement > impl)
{
