...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(SVGRenderingIntent*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 0;
private:
    static v8::Handle<v8::Object> wrapSlow(SVGRenderingIntent*);
};
...
v8::Handle<v8::Object> V8SVGRenderingIntent::wrap(SVGRenderingIntent* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8SVGRenderingIntent::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(SVGRenderingIntent* impl)
{
    if (!impl)
        return v8::Null();
    return V8SVGRenderingIntent::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< SVGRenderingIntent > impl)
{
