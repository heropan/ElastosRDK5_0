...
public:
    ...
    static HTMLTableCaptionElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLTableCaptionElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLTableCaptionElement*, bool forceNewObject = false);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLTableCaptionElement*);
};
...
v8::Handle<v8::Object> V8HTMLTableCaptionElement::wrap(HTMLTableCaptionElement* impl, bool forceNewObject)
{
    ...
    return V8HTMLTableCaptionElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLTableCaptionElement* impl, bool forceNewObject = false)
{
    if (!impl)
        return v8::Null();
    return V8HTMLTableCaptionElement::wrap(impl, forceNewObject);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLTableCaptionElement > impl, bool forceNewObject = false)
{
