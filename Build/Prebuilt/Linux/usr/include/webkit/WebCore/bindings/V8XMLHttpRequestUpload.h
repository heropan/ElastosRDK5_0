...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(XMLHttpRequestUpload*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(XMLHttpRequestUpload*);
};
...
v8::Handle<v8::Object> V8XMLHttpRequestUpload::wrap(XMLHttpRequestUpload* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8XMLHttpRequestUpload::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(XMLHttpRequestUpload* impl)
{
    if (!impl)
        return v8::Null();
    return V8XMLHttpRequestUpload::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< XMLHttpRequestUpload > impl)
{
