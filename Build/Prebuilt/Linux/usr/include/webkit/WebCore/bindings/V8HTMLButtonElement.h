...
public:
    ...
    static HTMLButtonElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLButtonElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLButtonElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLButtonElement*);
};
...
v8::Handle<v8::Object> V8HTMLButtonElement::wrap(HTMLButtonElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLButtonElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLButtonElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLButtonElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLButtonElement > impl)
{
