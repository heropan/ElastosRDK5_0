...
public:
    ...
    static Storage* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<Storage*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(Storage*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(Storage*);
};
...
v8::Handle<v8::Object> V8Storage::wrap(Storage* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8Storage::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(Storage* impl)
{
    if (!impl)
        return v8::Null();
    return V8Storage::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< Storage > impl)
{
