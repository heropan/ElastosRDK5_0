...
public:
    ...
    static NamedNodeMap* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<NamedNodeMap*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(NamedNodeMap*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(NamedNodeMap*);
};
...
v8::Handle<v8::Object> V8NamedNodeMap::wrap(NamedNodeMap* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8NamedNodeMap::wrapSlow(impl);
}

v8::Handle<v8::Value> toV8(NamedNodeMap*);
inline v8::Handle<v8::Value> toV8(PassRefPtr< NamedNodeMap > impl)
{
