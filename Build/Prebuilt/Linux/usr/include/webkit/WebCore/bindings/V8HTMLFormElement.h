...
public:
    ...
    static HTMLFormElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLFormElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLFormElement*, bool forceNewObject = false);
...
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLFormElement*);
};
...
v8::Handle<v8::Object> V8HTMLFormElement::wrap(HTMLFormElement* impl, bool forceNewObject)
{
    ...
    return V8HTMLFormElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLFormElement* impl, bool forceNewObject = false)
{
    if (!impl)
        return v8::Null();
    return V8HTMLFormElement::wrap(impl, forceNewObject);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLFormElement > impl, bool forceNewObject = false)
{
