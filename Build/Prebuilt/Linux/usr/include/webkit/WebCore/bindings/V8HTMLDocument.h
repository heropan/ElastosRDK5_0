...
public:
    ...
    static HTMLDocument* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLDocument*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLDocument*, bool forceNewObject = false);
...
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLDocument*);
};
...
v8::Handle<v8::Object> V8HTMLDocument::wrap(HTMLDocument* impl, bool forceNewObject)
{
    ...
    return V8HTMLDocument::wrapSlow(impl);
}

v8::Handle<v8::Value> toV8(HTMLDocument*, bool forceNewObject = false);
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLDocument > impl, bool forceNewObject = false)
{
