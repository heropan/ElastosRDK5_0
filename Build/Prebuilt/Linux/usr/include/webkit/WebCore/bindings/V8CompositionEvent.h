...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(CompositionEvent*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 0;
private:
    static v8::Handle<v8::Object> wrapSlow(CompositionEvent*);
};
...
v8::Handle<v8::Object> V8CompositionEvent::wrap(CompositionEvent* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8CompositionEvent::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(CompositionEvent* impl)
{
    if (!impl)
        return v8::Null();
    return V8CompositionEvent::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< CompositionEvent > impl)
{
