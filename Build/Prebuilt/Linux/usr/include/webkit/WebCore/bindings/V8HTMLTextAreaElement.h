...
public:
    ...
    static HTMLTextAreaElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLTextAreaElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLTextAreaElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLTextAreaElement*);
};
...
v8::Handle<v8::Object> V8HTMLTextAreaElement::wrap(HTMLTextAreaElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLTextAreaElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLTextAreaElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLTextAreaElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLTextAreaElement > impl)
{
