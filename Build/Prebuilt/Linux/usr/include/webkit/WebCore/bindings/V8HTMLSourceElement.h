...
public:
    ...
    static HTMLSourceElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLSourceElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLSourceElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLSourceElement*);
};
...
v8::Handle<v8::Object> V8HTMLSourceElement::wrap(HTMLSourceElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLSourceElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLSourceElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLSourceElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLSourceElement > impl)
{
