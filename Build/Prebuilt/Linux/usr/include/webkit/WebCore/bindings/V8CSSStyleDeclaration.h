...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(CSSStyleDeclaration*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(CSSStyleDeclaration*);
};
...
v8::Handle<v8::Object> V8CSSStyleDeclaration::wrap(CSSStyleDeclaration* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8CSSStyleDeclaration::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(CSSStyleDeclaration* impl)
{
    if (!impl)
        return v8::Null();
    return V8CSSStyleDeclaration::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< CSSStyleDeclaration > impl)
{
