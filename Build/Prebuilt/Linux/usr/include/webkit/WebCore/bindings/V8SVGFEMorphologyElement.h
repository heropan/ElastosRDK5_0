...
public:
    ...
    static SVGFEMorphologyElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<SVGFEMorphologyElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(SVGFEMorphologyElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(SVGFEMorphologyElement*);
};
...
v8::Handle<v8::Object> V8SVGFEMorphologyElement::wrap(SVGFEMorphologyElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8SVGFEMorphologyElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(SVGFEMorphologyElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8SVGFEMorphologyElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< SVGFEMorphologyElement > impl)
{
