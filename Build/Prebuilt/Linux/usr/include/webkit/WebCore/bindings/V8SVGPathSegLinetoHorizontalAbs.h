...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(SVGPathSegLinetoHorizontalAbs*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 0;
private:
    static v8::Handle<v8::Object> wrapSlow(SVGPathSegLinetoHorizontalAbs*);
};
...
v8::Handle<v8::Object> V8SVGPathSegLinetoHorizontalAbs::wrap(SVGPathSegLinetoHorizontalAbs* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8SVGPathSegLinetoHorizontalAbs::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(SVGPathSegLinetoHorizontalAbs* impl)
{
    if (!impl)
        return v8::Null();
    return V8SVGPathSegLinetoHorizontalAbs::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< SVGPathSegLinetoHorizontalAbs > impl)
{
