...
public:
    ...
    static HTMLImageElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLImageElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLImageElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLImageElement*);
};
...
v8::Handle<v8::Object> V8HTMLImageElement::wrap(HTMLImageElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLImageElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLImageElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLImageElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLImageElement > impl)
{
