...
public:
    ...
    static HTMLObjectElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLObjectElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLObjectElement*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLObjectElement*);
};
...
v8::Handle<v8::Object> V8HTMLObjectElement::wrap(HTMLObjectElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLObjectElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLObjectElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLObjectElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLObjectElement > impl)
{
