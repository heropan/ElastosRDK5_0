...
public:
    ...
    static HTMLTableRowElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLTableRowElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLTableRowElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLTableRowElement*);
};
...
v8::Handle<v8::Object> V8HTMLTableRowElement::wrap(HTMLTableRowElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLTableRowElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLTableRowElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLTableRowElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLTableRowElement > impl)
{
