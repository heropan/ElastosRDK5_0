...
public:
    ...
    static NodeList* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<NodeList*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(NodeList*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(NodeList*);
};
...
v8::Handle<v8::Object> V8NodeList::wrap(NodeList* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8NodeList::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(NodeList* impl)
{
    if (!impl)
        return v8::Null();
    return V8NodeList::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< NodeList > impl)
{
