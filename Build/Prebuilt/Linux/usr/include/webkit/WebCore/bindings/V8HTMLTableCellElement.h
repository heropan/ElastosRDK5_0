...
public:
    ...
    static HTMLTableCellElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLTableCellElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLTableCellElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLTableCellElement*);
};
...
v8::Handle<v8::Object> V8HTMLTableCellElement::wrap(HTMLTableCellElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLTableCellElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLTableCellElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLTableCellElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLTableCellElement > impl)
{
