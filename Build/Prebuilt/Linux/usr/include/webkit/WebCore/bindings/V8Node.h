...
public:
    ...
    static Node* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<Node*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(Node*, bool forceNewObject = false);
...
private:
    static v8::Handle<v8::Object> wrapSlow(Node*);
};
...
inline v8::Handle<v8::Value> toV8(PassRefPtr< Node > impl, bool forceNewObject = false)
{
