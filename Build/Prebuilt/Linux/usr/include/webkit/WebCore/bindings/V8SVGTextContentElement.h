...
public:
    ...
    static SVGTextContentElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<SVGTextContentElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(SVGTextContentElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(SVGTextContentElement*);
};
...
v8::Handle<v8::Object> V8SVGTextContentElement::wrap(SVGTextContentElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8SVGTextContentElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(SVGTextContentElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8SVGTextContentElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< SVGTextContentElement > impl)
{
