...
public:
    ...
    static HTMLMediaElement* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<HTMLMediaElement*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(HTMLMediaElement*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(HTMLMediaElement*);
};
...
v8::Handle<v8::Object> V8HTMLMediaElement::wrap(HTMLMediaElement* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8HTMLMediaElement::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(HTMLMediaElement* impl)
{
    if (!impl)
        return v8::Null();
    return V8HTMLMediaElement::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< HTMLMediaElement > impl)
{
