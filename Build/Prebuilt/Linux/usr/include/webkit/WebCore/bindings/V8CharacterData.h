...
public:
    ...
    static CharacterData* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<CharacterData*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(CharacterData*);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(CharacterData*);
};
...
v8::Handle<v8::Object> V8CharacterData::wrap(CharacterData* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8CharacterData::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(CharacterData* impl)
{
    if (!impl)
        return v8::Null();
    return V8CharacterData::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< CharacterData > impl)
{
