...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(Element*, bool forceNewObject = false);
    static void derefObject(void*);
    static WrapperTypeInfo info;
    static const int eventListenerCacheIndex = v8DefaultWrapperInternalFieldCount + 0;
    static const int internalFieldCount = v8DefaultWrapperInternalFieldCount + 1;
private:
    static v8::Handle<v8::Object> wrapSlow(Element*);
};
...
v8::Handle<v8::Object> V8Element::wrap(Element* impl, bool forceNewObject)
{
    ...
    return V8Element::wrapSlow(impl);
}

v8::Handle<v8::Value> toV8(Element*, bool forceNewObject = false);
inline v8::Handle<v8::Value> toV8(PassRefPtr< Element > impl, bool forceNewObject = false)
{
