...
v8::Handle<v8::Object> V8CSSRuleList::wrap(CSSRuleList* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8CSSRuleList::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(CSSRuleList* impl)
{
    if (!impl)
        return v8::Null();
    return V8CSSRuleList::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< CSSRuleList > impl)
{
