...
public:
    ...
    static CanvasRenderingContext2D* toNative(v8::Handle<v8::Object> object)
    {
        return reinterpret_cast<CanvasRenderingContext2D*>(object->GetPointerFromInternalField(v8DOMWrapperObjectIndex));
    }
    inline static v8::Handle<v8::Object> wrap(CanvasRenderingContext2D*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(CanvasRenderingContext2D*);
};
...
v8::Handle<v8::Object> V8CanvasRenderingContext2D::wrap(CanvasRenderingContext2D* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8CanvasRenderingContext2D::wrapSlow(impl);
}

inline v8::Handle<v8::Value> toV8(CanvasRenderingContext2D* impl)
{
    if (!impl)
        return v8::Null();
    return V8CanvasRenderingContext2D::wrap(impl);
}
inline v8::Handle<v8::Value> toV8(PassRefPtr< CanvasRenderingContext2D > impl)
{
