...
public:
    ...
    WTF::String hash() const;
    void setHash(const WTF::String&);

    WTF::String host() const;
    void setHost(const WTF::String&);

    WTF::String hostname() const;
    void setHostname(const WTF::String&);

    WTF::String pathname() const;
    void setPathname(const WTF::String&);

    WTF::String port() const;
    void setPort(const WTF::String&);

    WTF::String protocol() const;
    void setProtocol(const WTF::String&);

    WTF::String search() const;
    void setSearch(const WTF::String&);

    WTF::String origin() const;

    WTF::String getParameter(const WTF::String&) const;

    WTF::String text() const;
...
void handleLinkClick(Event*, Document*, const WTF::String& url, const WTF::String& target, bool hideReferrer = false);
