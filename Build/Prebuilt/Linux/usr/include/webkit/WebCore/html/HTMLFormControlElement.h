...
public:
    ...
    WTF::String validationMessage();
    void updateVisibleValidationMessage();
    void hideVisibleValidationMessage();
    bool checkValidity(WTF::Vector<RefPtr<FormAssociatedElement> >* unhandledInvalidControls = 0);
    // This must be called when a validation constraint or control value is changed.
    void setNeedsValidityCheck();
    void setCustomValidity(const WTF::String&);
...
private:
    ...
    WTF::String visibleValidationMessage() const;
...
public:
    ...
    WTF::String strippedPlaceholder() const;
...
protected:
    ...
    virtual void parseMappedAttribute(Attribute*);
    virtual void setTextAsOfLastFormControlChangeEvent(WTF::String text) { m_textAsOfLastFormControlChangeEvent = text; }
...
private:
    ...
    WTF::String m_textAsOfLastFormControlChangeEvent;
};
