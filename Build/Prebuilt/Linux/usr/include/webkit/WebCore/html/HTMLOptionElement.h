...
public:
    ...
    static PassRefPtr<HTMLOptionElement> createForJSConstructor(Document*, const WTF::String& data, const WTF::String& value,
       bool defaultSelected, bool selected, ExceptionCode&);

    virtual WTF::String text() const;
    void setText(const WTF::String&, ExceptionCode&);
...
private:
    ...
    virtual WTF::String textIndentedToRespectGroupLabel() const;
