...
public:
    ...
    bool valueMissing(const WTF::String&) const;
    bool patternMismatch(const WTF::String&) const;
    bool tooLong(const WTF::String&, NeedsToCheckDirtyFlag) const;
    bool rangeUnderflow(const WTF::String&) const;
    bool rangeOverflow(const WTF::String&) const;
    ...
    // For ValidityState.
    bool stepMismatch(const WTF::String&) const;
    WTF::String minimumString() const;
    WTF::String maximumString() const;
    WTF::String stepBaseString() const;
    WTF::String stepString() const;
    WTF::String typeMismatchText() const;
    WTF::String valueMissingText() const;
    ...
    void setType(const WTF::String&);

    virtual WTF::String value() const;
    virtual void setValue(const WTF::String&, bool sendChangeEvent = false);
    virtual void setValueForUser(const WTF::String&);
    // Checks if the specified string would be a valid value.
    // We should not call this for types with no string value such as CHECKBOX and RADIO.
    bool isValidValue(const WTF::String&) const;

    virtual const WTF::String& suggestedValue() const;
    void setSuggestedValue(const WTF::String&);
    ...
    virtual WTF::String placeholder() const;
    virtual void setPlaceholder(const WTF::String&);

    WTF::String valueWithDefault() const;

    virtual void setValueFromRenderer(const WTF::String&);
    void setFileListFromRenderer(const WTF::Vector<WTF::String>&);
    ...
    WTF::String accept() const;
    WTF::String alt() const;
...
#if ENABLE(WCSS)
    void setWapInputFormat(WTF::String& mask);
#endif
...
private:
    ...
    virtual WTF::String visibleValue() const;
    virtual WTF::String convertFromVisibleValue(const WTF::String&) const;
    virtual bool isAcceptableValue(const WTF::String&) const;
    virtual WTF::String sanitizeValue(const WTF::String&) const;
