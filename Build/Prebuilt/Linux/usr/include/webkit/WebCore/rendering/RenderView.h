...
public:
    ...
    const WTF::HashSet<RenderWidget*>& widgets() const { return m_widgets; }
#endif
...
private:
    ...
    size_t getRetainedWidgets(WTF::Vector<RenderWidget*>&);
    void releaseWidgets(WTF::Vector<RenderWidget*>&);
...
protected:
    ...
    typedef WTF::HashSet<RenderWidget*> RenderWidgetSet;
