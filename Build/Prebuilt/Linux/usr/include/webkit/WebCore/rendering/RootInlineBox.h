...
public:
    ...
    void appendFloat(RenderBox* floatingBox)
    {
        ...
        if (m_floats)
            ...
            m_floats= adoptPtr(new WTF::Vector<RenderBox*>(1, floatingBox));
    }

    WTF::Vector<RenderBox*>* floatsPtr() { ASSERT(!isDirty()); return m_floats.get(); }
...
private:
    ...
    OwnPtr<WTF::Vector<RenderBox*> > m_floats;
