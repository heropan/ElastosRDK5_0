...
public:
    ...
    WTF::Vector<ColumnStruct>& columns() { return m_columns; }
    WTF::Vector<int>& columnPositions() { return m_columnPos; }
...
private:
    ...
    mutable WTF::Vector<int> m_columnPos;
    mutable WTF::Vector<ColumnStruct> m_columns;
