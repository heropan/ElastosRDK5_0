...
public:
    ...
    WTF::HashSet<RenderBox*>* percentHeightDescendants() const;
...
protected:
    ...
    virtual void addFocusRingRects(WTF::Vector<IntRect>&, int tx, int ty);
...
private:
    ...
    void checkFloatsInCleanLine(RootInlineBox*, WTF::Vector<FloatWithRect>&, size_t& floatIndex, bool& encounteredNewFloat, bool& dirtiedByFloat);
    RootInlineBox* determineStartPosition(bool& firstLine, bool& fullLayout, bool& previousLineBrokeCleanly,
                                          InlineBidiResolver&, WTF::Vector<FloatWithRect>& floats, unsigned& numCleanFloats,
                                          bool& useRepaintBounds, int& repaintTop, int& repaintBottom);
    RootInlineBox* determineEndPosition(RootInlineBox* startBox, WTF::Vector<FloatWithRect>& floats, size_t floatIndex, InlineIterator& cleanLineStart,
    ...
    InlineIterator findNextLineBreak(InlineBidiResolver&, bool firstLine, bool& isLineEmpty, LineBreakIteratorInfo&, bool& previousLineBrokeCleanly, bool& hyphenated,
                                     EClear*, FloatingObject* lastFloatFromPreviousLine, WTF::Vector<RenderBox*>& positionedObjects);
