...
typedef WTF::HashMap<const InlineTextBox*, pair<WTF::Vector<const SimpleFontData*>, GlyphOverflow> > GlyphOverflowAndFallbackFontsMap;
...
public:
    ...
    typedef void (*CustomInlineBoxRangeReverse)(void* userData, WTF::Vector<InlineBox*>::iterator first, WTF::Vector<InlineBox*>::iterator last);
    void collectLeafBoxesInLogicalOrder(WTF::Vector<InlineBox*>&, CustomInlineBoxRangeReverse customReverseImplementation = 0, void* userData = 0) const;
