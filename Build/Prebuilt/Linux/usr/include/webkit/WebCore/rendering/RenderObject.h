...
public:
    ...
    void collectDashboardRegions(WTF::Vector<DashboardRegionValue>&);
#endif
    ...
    virtual void absoluteRects(WTF::Vector<IntRect>&, int, int) { }
    ...
    void absoluteFocusRingQuads(WTF::Vector<FloatQuad>&);
