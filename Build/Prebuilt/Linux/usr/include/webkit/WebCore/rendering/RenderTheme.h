...
public:
    ...
    virtual WTF::String extraDefaultStyleSheet() { return WTF::String(); }
    virtual WTF::String extraQuirksStyleSheet() { return WTF::String(); }
#if ENABLE(VIDEO)
    virtual WTF::String extraMediaControlsStyleSheet() { return WTF::String(); };
#if ENABLE(FULLSCREEN_API)
    virtual WTF::String extraFullScreenStyleSheet() { return WTF::String(); };
#endif
#endif
    ...
    virtual WTF::String formatMediaControlsTime(float time) const;
    virtual WTF::String formatMediaControlsCurrentTime(float currentTime, float duration) const;
    virtual WTF::String formatMediaControlsRemainingTime(float currentTime, float duration) const;
