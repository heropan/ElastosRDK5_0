...
private:
    ...
    void culledInlineAbsoluteRects(const RenderInline* container, WTF::Vector<IntRect>&, const IntSize&);
    void culledInlineAbsoluteQuads(const RenderInline* container, WTF::Vector<FloatQuad>&);
    ...
    virtual void addDashboardRegions(WTF::Vector<DashboardRegionValue>&);
#endif
