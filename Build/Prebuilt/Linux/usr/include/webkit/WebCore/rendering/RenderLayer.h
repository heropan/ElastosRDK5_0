...
public:
    ...
    WTF::Vector<RenderLayer*>* posZOrderList() const { return m_posZOrderList; }
    WTF::Vector<RenderLayer*>* negZOrderList() const { return m_negZOrderList; }

    void dirtyNormalFlowList();
    void updateNormalFlowList();
    WTF::Vector<RenderLayer*>* normalFlowList() const { return m_normalFlowList; }
...
private:
    ...
    void collectLayers(WTF::Vector<RenderLayer*>*&, WTF::Vector<RenderLayer*>*&);
    ...
    void paintLayer(RenderLayer* rootLayer, GraphicsContext*, const IntRect& paintDirtyRect,
                    ...
                    PaintLayerFlags = 0);
    void paintList(WTF::Vector<RenderLayer*>*, RenderLayer* rootLayer, GraphicsContext* p,
    ...
    void paintChildLayerIntoColumns(RenderLayer* childLayer, RenderLayer* rootLayer, GraphicsContext*,
                                    const IntRect& paintDirtyRect, PaintBehavior,
                                    RenderObject* paintingRoot, OverlapTestRequestMap*,
                                    PaintLayerFlags, const WTF::Vector<RenderLayer*>& columnLayers, size_t columnIndex);

    RenderLayer* hitTestLayer(RenderLayer* rootLayer, RenderLayer* containerLayer, const HitTestRequest& request, HitTestResult& result,
                              const IntRect& hitTestRect, const IntPoint& hitTestPoint, bool appliedTransform,
                              const HitTestingTransformState* transformState = 0, double* zOffset = 0);
    RenderLayer* hitTestList(WTF::Vector<RenderLayer*>*, RenderLayer* rootLayer, const HitTestRequest& request, HitTestResult& result,
    ...
    RenderLayer* hitTestChildLayerColumns(RenderLayer* childLayer, RenderLayer* rootLayer, const HitTestRequest& request, HitTestResult& result,
                                          const IntRect& hitTestRect, const IntPoint& hitTestPoint,
                                          const HitTestingTransformState* transformState, double* zOffset,
                                          const WTF::Vector<RenderLayer*>& columnLayers, size_t columnIndex);
...
protected:
    ...
    // z-indices.
    WTF::Vector<RenderLayer*>* m_posZOrderList;
    WTF::Vector<RenderLayer*>* m_negZOrderList;

    // This list contains child layers that cannot create stacking contexts.  For now it is just
    // overflow layers, but that may change in the future.
    WTF::Vector<RenderLayer*>* m_normalFlowList;
