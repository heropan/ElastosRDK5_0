...
public:
    ...
    WTF::String spellingToolTip(TextDirection&) const;
    WTF::String replacedString() const;
    WTF::String title(TextDirection&) const;
    WTF::String altDisplayString() const;
    WTF::String titleDisplayString() const;
    Image* image() const;
    IntRect imageRect() const;
    KURL absoluteImageURL() const;
    KURL absoluteMediaURL() const;
    KURL absoluteLinkURL() const;
    WTF::String textContent() const;
...
WTF::String displayString(const WTF::String&, const Node*);
