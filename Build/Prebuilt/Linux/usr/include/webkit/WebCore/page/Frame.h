...
namespace WebCore {
    ...
    // ======== All public functions below this point are candidates to move out of Frame into another class. ========
        ...
        WTF::String layerTreeAsText(bool showDebugInfo = false) const;
        ...
        WTF::String documentTypeString() const;

        WTF::String displayStringModifiedByEncoding(const WTF::String& str) const
        {
        ...
        WTF::String searchForLabelsAboveCell(RegularExpression*, HTMLTableCellElement*, size_t* resultDistanceFromStartOfCell);
        WTF::String searchForLabelsBeforeElement(const WTF::Vector<WTF::String>& labels, Element*, size_t* resultDistance, bool* resultIsInCellAbove);
        WTF::String matchLabelsAgainstElement(const WTF::Vector<WTF::String>& labels, Element*);
    ...
    private:
        ...
        WTF::HashSet<FrameDestructionObserver*> m_destructionObservers;
        ...
        WTF::HashSet<DOMWindow*> m_liveFormerWindows;
    ...
    private:
        ...
        virtual void tiledBackingStorePaintEnd(const WTF::Vector<IntRect>& paintedArea);
