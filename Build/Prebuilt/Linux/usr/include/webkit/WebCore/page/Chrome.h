...
namespace WebCore {
    ...
    public:
        ...
        bool runBeforeUnloadConfirmPanel(const WTF::String& message, Frame* frame);

        void closeWindowSoon();

        void runJavaScriptAlert(Frame*, const WTF::String&);
        bool runJavaScriptConfirm(Frame*, const WTF::String&);
        bool runJavaScriptPrompt(Frame*, const WTF::String& message, const WTF::String& defaultValue, WTF::String& result);
        void setStatusbarText(Frame*, const WTF::String&);
        bool shouldInterruptJavaScript();

#if ENABLE(REGISTER_PROTOCOL_HANDLER)
        void registerProtocolHandler(const WTF::String& scheme, const WTF::String& baseURL, const WTF::String& url, const WTF::String& title);
#endif
        ...
        void chooseIconForFiles(const WTF::Vector<WTF::String>&, FileChooser*);
#if ENABLE(DIRECTORY_UPLOAD)
        void enumerateChosenDirectory(const WTF::String&, FileChooser*);
#endif
