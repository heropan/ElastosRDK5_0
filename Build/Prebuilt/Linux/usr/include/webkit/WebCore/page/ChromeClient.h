...
namespace WebCore {
    ...
    public:
        ...
        virtual void addMessageToConsole(MessageSource, MessageType, MessageLevel, const WTF::String& message, unsigned int lineNumber, const WTF::String& sourceID) = 0;

        virtual bool canRunBeforeUnloadConfirmPanel() = 0;
        virtual bool runBeforeUnloadConfirmPanel(const WTF::String& message, Frame* frame) = 0;

        virtual void closeWindowSoon() = 0;

        virtual void runJavaScriptAlert(Frame*, const WTF::String&) = 0;
        virtual bool runJavaScriptConfirm(Frame*, const WTF::String&) = 0;
        virtual bool runJavaScriptPrompt(Frame*, const WTF::String& message, const WTF::String& defaultValue, WTF::String& result) = 0;
        ...
        virtual void registerProtocolHandler(const WTF::String& scheme, const WTF::String& baseURL, const WTF::String& url, const WTF::String& title) = 0;
#endif
        ...
        virtual void setToolTip(const WTF::String&, TextDirection) = 0;

        virtual void print(Frame*) = 0;

#if ENABLE(DATABASE)
        virtual void exceededDatabaseQuota(Frame*, const WTF::String& databaseName) = 0;
#endif
        ...
        virtual void chooseIconForFiles(const WTF::Vector<WTF::String>&, FileChooser*) = 0;

#if ENABLE(DIRECTORY_UPLOAD)
        // Asychronous request to enumerate all files in a directory chosen by the user.
        virtual void enumerateChosenDirectory(const WTF::String&, FileChooser*) = 0;
#endif
