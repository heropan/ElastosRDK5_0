...
public:
    ...
    WTF::String mediaType() const;
    void setMediaType(const WTF::String&);
    ...
    bool scrollToAnchor(const WTF::String&);
...
private:
    ...
    virtual void getTickmarks(WTF::Vector<IntRect>&) const;
    ...
    typedef WTF::HashSet<RenderEmbeddedObject*> RenderEmbeddedObjectSet;
    ...
    WTF::String m_mediaType;
    WTF::String m_mediaTypeWhenNotPrinting;
    ...
    WTF::Vector<IntRect> m_repaintRects;
