...
namespace WebCore {
    ...
    public:
        ...
        void setGroupName(const WTF::String&);
        const WTF::String& groupName() const;
        ...
        static ViewMode stringToViewMode(const WTF::String&);
        ...
        bool findString(const WTF::String&, TextCaseSensitivity, FindDirection, bool shouldWrap);
        unsigned markAllMatchesForText(const WTF::String&, FindOptions, bool shouldHighlight, unsigned);
        // FIXME: Switch callers over to the FindOptions version and retire this one.
        unsigned markAllMatchesForText(const WTF::String&, TextCaseSensitivity, bool shouldHighlight, unsigned);
        ...
        const WTF::String& userStyleSheet() const;
        ...
        typedef WTF::HashSet<ScrollableArea*> ScrollableAreaSet;
    ...
    private:
        ...
        WTF::String m_userStyleSheetPath;
        mutable WTF::String m_userStyleSheet;
