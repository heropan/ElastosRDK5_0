...
public:
...
#if PLATFORM(ANDROID) && ENABLE(APPLICATION_INSTALLED)
    bool isApplicationInstalled(const WTF::String& name, PassRefPtr<ApplicationInstalledCallback> callback);
    ...
    void registerProtocolHandler(const WTF::String& scheme, const WTF::String& url, const WTF::String& title, ExceptionCode&);
#endif

#if ENABLE(MEDIA_STREAM)
    virtual void webkitGetUserMedia(const WTF::String& options, PassRefPtr<NavigatorUserMediaSuccessCallback>,
...
private:
    ...
    WTF::String m_applicationNameQuery;
#endif
};
