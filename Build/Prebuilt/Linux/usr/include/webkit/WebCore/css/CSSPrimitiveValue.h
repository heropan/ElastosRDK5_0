...
public:
    ...
    static PassRefPtr<CSSPrimitiveValue> create(const WTF::String& value, UnitTypes type) { return adoptRef(new CSSPrimitiveValue(value, type)); }
    ...
    void setStringValue(unsigned short stringType, const WTF::String& stringValue, ExceptionCode&);
    WTF::String getStringValue(ExceptionCode&) const;
    WTF::String getStringValue() const;
    ...
    virtual bool parseString(const WTF::String&, bool = false);
...
protected:
    ...
    CSSPrimitiveValue(const WTF::String&, UnitTypes);
