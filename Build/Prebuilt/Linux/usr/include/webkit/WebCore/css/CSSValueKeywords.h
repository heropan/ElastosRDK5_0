...
const int CSSValueTouch = 488;
const int CSSValueLr = 489;
const int CSSValueRl = 490;
const int CSSValueTb = 491;
const int CSSValueLrTb = 492;
const int CSSValueRlTb = 493;
const int CSSValueTbRl = 494;
const int CSSValueHorizontalTb = 495;
const int CSSValueVerticalRl = 496;
const int CSSValueVerticalLr = 497;
const int CSSValueHorizontalBt = 498;
const int CSSValueOver = 499;
const int CSSValueUnder = 500;
const int CSSValueFilled = 501;
const int CSSValueOpen = 502;
const int CSSValueDot = 503;
const int CSSValueDoubleCircle = 504;
const int CSSValueTriangle = 505;
const int CSSValueSesame = 506;
const int CSSValueEllipse = 507;
const int CSSValueClosestSide = 508;
const int CSSValueClosestCorner = 509;
const int CSSValueFarthestSide = 510;
const int CSSValueFarthestCorner = 511;
const int CSSValueUpright = 512;
const int CSSValueVerticalRight = 513;
const int CSSValueFont = 514;
const int CSSValueGlyphs = 515;
const int CSSValueInlineBox = 516;
const int CSSValueReplaced = 517;
...
const int CSSValueOptimizequality = 652;
const int CSSValueCrispedges = 653;
const int CSSValueButt = 654;
const int CSSValueMiter = 655;
const int CSSValueBevel = 656;
const int CSSValueBeforeEdge = 657;
const int CSSValueAfterEdge = 658;
const int CSSValueCentral = 659;
const int CSSValueTextBeforeEdge = 660;
const int CSSValueTextAfterEdge = 661;
const int CSSValueIdeographic = 662;
const int CSSValueAlphabetic = 663;
const int CSSValueHanging = 664;
const int CSSValueMathematical = 665;
const int CSSValueUseScript = 666;
const int CSSValueNoChange = 667;
const int CSSValueResetSize = 668;
const int CSSValueNonScalingStroke = 669;
const int numCSSValueKeywords = 670;
