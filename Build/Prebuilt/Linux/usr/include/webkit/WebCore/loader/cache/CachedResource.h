...
public:
    ...
    CachedResource(const WTF::String& url, Type);
    ...
    virtual void setEncoding(const WTF::String&) { }
    virtual WTF::String encoding() const { return WTF::String(); }
    ...
    WTF::String accept() const { return m_accept; }
    void setAccept(const WTF::String& accept) { m_accept = accept; }
...
private:
    ...
    WTF::HashSet<CachedResourceHandleBase*> m_handlesToRevalidate;
};
