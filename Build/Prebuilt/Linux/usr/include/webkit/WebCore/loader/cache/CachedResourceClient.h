...
namespace WebCore {
    ...
    public:
        ...
        virtual void setCSSStyleSheet(const WTF::String& /* href */, const KURL& /* baseURL */, const WTF::String& /* charset */, const CachedCSSStyleSheet*) { }
        virtual void setXSLStyleSheet(const WTF::String& /* href */, const KURL& /* baseURL */, const WTF::String& /* sheet */) { }
