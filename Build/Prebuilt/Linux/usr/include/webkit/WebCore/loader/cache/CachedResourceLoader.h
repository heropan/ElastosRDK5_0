...
public:
    ...
    typedef WTF::HashMap<String, CachedResourceHandle<CachedResource> > DocumentResourceMap;
...
private:
    ...
    WTF::HashSet<String> m_validatedURLs;
    mutable DocumentResourceMap m_documentResources;
    Document* m_document;

    typedef WTF::HashSet<RefPtr<CachedResourceRequest> > RequestSet;
    ...
    WTF::Deque<PendingPreload> m_pendingPreloads;
