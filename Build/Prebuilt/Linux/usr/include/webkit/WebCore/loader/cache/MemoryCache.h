...
public:
    ...
    typedef WTF::HashMap<WTF::String, CachedResource*> CachedResourceMap;
    ...
    typedef WTF::HashSet<RefPtr<SecurityOrigin>, SecurityOriginHash> SecurityOriginSet;
...
private:
    ...
    WTF::Vector<LRUList, 32> m_allResources;
    ...
    WTF::HashMap<WTF::String, CachedResource*> m_resources;
};
