...
void setViewportFeature(const WTF::String& keyString, const WTF::String& valueString, Document*, void* data);
void reportViewportWarning(Document*, ViewportErrorCode, const WTF::String& replacement1, const WTF::String& replacement2);
