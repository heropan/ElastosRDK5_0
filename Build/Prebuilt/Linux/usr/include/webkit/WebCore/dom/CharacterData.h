...
public:
    WTF::String data() const { return m_data; }
    void setData(const WTF::String&, ExceptionCode&);
    unsigned length() const { return m_data->length(); }
    WTF::String substringData(unsigned offset, unsigned count, ExceptionCode&);
    void appendData(const WTF::String&, ExceptionCode&);
    void insertData(unsigned offset, const WTF::String&, ExceptionCode&);
    void deleteData(unsigned offset, unsigned count, ExceptionCode&);
    void replaceData(unsigned offset, unsigned count, const WTF::String&, ExceptionCode&);
...
protected:
    CharacterData(Document* document, const WTF::String& text, ConstructionType type)
        : Node(document, type)
