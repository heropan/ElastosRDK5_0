...
public:
    ...
    virtual PassRefPtr<DocumentFragment> deprecatedCreateContextualFragment(const WTF::String&, FragmentScriptingPermission = FragmentScriptingAllowed);
    ...
    bool hasAttribute(const WTF::String& name) const;
    bool hasAttributeNS(const WTF::String& namespaceURI, const WTF::String& localName) const;

    const AtomicString& getAttribute(const WTF::String& name) const;
    const AtomicString& getAttributeNS(const WTF::String& namespaceURI, const WTF::String& localName) const;
    ...
    void removeAttribute(const WTF::String& name, ExceptionCode&);
    void removeAttributeNS(const WTF::String& namespaceURI, const WTF::String& localName, ExceptionCode&);

    PassRefPtr<Attr> getAttributeNode(const WTF::String& name);
    PassRefPtr<Attr> getAttributeNodeNS(const WTF::String& namespaceURI, const WTF::String& localName);
    ...
    WTF::String tagName() const { return nodeName(); }
    ...
    WTF::String nodeNamePreservingCase() const;
    ...
    virtual WTF::String target() const { return WTF::String(); }
    ...
    WTF::String outerText() const;

    virtual WTF::String title() const;

    WTF::String openTagStartToString() const;
    ...
    bool webkitMatchesSelector(const WTF::String& selectors, ExceptionCode&);
    ...
    virtual bool saveFormControlState(WTF::String&) const { return false; }
