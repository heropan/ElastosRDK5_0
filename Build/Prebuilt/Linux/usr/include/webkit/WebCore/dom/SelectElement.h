...
public:
    ...
    virtual const WTF::Vector<Element*>& listItems() const = 0;
...
protected:
    ...
    static bool saveFormControlState(const SelectElementData&, const Element*, WTF::String& state);
    static void restoreFormControlState(SelectElementData&, Element*, const WTF::String& state);
...
public:
    ...
    WTF::Vector<bool>& lastOnChangeSelection() { return m_lastOnChangeSelection; }
    ...
    WTF::Vector<bool>& cachedStateForActiveSelection() { return m_cachedStateForActiveSelection; }
    ...
    WTF::Vector<Element*>& rawListItems() { return m_listItems; }
    WTF::Vector<Element*>& listItems(const Element*);
    const WTF::Vector<Element*>& listItems(const Element*) const;
    ...
    WTF::String& typedString() { return m_typedString; }
    void setTypedString(const WTF::String& value) { m_typedString = value; }
...
private:
    ...
    WTF::Vector<bool> m_lastOnChangeSelection;
    bool m_userDrivenChange;

    bool m_activeSelectionState;
    int m_activeSelectionAnchorIndex;
    int m_activeSelectionEndIndex;
    WTF::Vector<bool> m_cachedStateForActiveSelection;

    bool m_recalcListItems;
    WTF::Vector<Element*> m_listItems;

    // Instance variables for type-ahead find
    UChar m_repeatingChar;
    DOMTimeStamp m_lastCharTime;
    WTF::String m_typedString;
};
