...
public:
    ...
    void addCSSLength(Attribute*, int id, const WTF::String& value);
    void addCSSProperty(Attribute*, int id, const WTF::String& value);
    void addCSSProperty(Attribute*, int id, int value);
    void addCSSImageProperty(Attribute*, int propertyID, const WTF::String& url);
    void addCSSColor(Attribute*, int id, const WTF::String& color);
    ...
    virtual void additionalAttributeStyleDecls(WTF::Vector<CSSMutableStyleDeclaration*>&) { }
