...
public:
    ...
    PassRefPtr<Node> getNamedItem(const WTF::String& name) const;
    PassRefPtr<Node> removeNamedItem(const WTF::String& name, ExceptionCode&);

    PassRefPtr<Node> getNamedItemNS(const WTF::String& namespaceURI, const WTF::String& localName) const;
    PassRefPtr<Node> removeNamedItemNS(const WTF::String& namespaceURI, const WTF::String& localName, ExceptionCode&);
    ...
    void copyAttributesToVector(WTF::Vector<RefPtr<Attribute> >&);
    ...
    void setClass(const WTF::String&);
...
private:
    ...
    Attribute* getAttributeItem(const WTF::String& name, bool shouldIgnoreAttributeCase) const;
    Attribute* getAttributeItemSlowCase(const WTF::String& name, bool shouldIgnoreAttributeCase) const;
    ...
    Element* m_element;
    WTF::Vector<RefPtr<Attribute> > m_attributes;
...
inline Attribute* NamedNodeMap::getAttributeItem(const WTF::String& name, bool shouldIgnoreAttributeCase) const
{
    unsigned len = length();
