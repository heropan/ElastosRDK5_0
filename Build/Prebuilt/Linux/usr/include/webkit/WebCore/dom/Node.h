...
public:
    ...
    static bool isSupported(const WTF::String& feature, const WTF::String& version);
    ...
    virtual WTF::String nodeName() const = 0;
    virtual WTF::String nodeValue() const;
    virtual void setNodeValue(const WTF::String&, ExceptionCode&);
    ...
    WTF::String lookupPrefix(const AtomicString& namespaceURI) const;
    WTF::String lookupNamespaceURI(const WTF::String& prefix) const;
    WTF::String lookupNamespacePrefix(const AtomicString& namespaceURI, const Element* originalElement) const;

    WTF::String textContent(bool convertBRsToNewlines = false) const;
    void setTextContent(const WTF::String&, ExceptionCode&);
    ...
    void removeCachedClassNodeList(ClassNodeList*, const WTF::String&);
    void removeCachedNameNodeList(NameNodeList*, const WTF::String&);
    ...
    PassRefPtr<NodeList> getElementsByName(const WTF::String& elementName);
    PassRefPtr<NodeList> getElementsByClassName(const WTF::String& classNames);

    PassRefPtr<Element> querySelector(const WTF::String& selectors, ExceptionCode&);
    PassRefPtr<NodeList> querySelectorAll(const WTF::String& selectors, ExceptionCode&);
