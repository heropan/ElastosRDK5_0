...
public:
    ...
    PassRefPtr<Text> createTextNode(const WTF::String& data);
    PassRefPtr<Comment> createComment(const WTF::String& data);
    PassRefPtr<CDATASection> createCDATASection(const WTF::String& data, ExceptionCode&);
    PassRefPtr<ProcessingInstruction> createProcessingInstruction(const WTF::String& target, const WTF::String& data, ExceptionCode&);
    PassRefPtr<Attr> createAttribute(const WTF::String& name, ExceptionCode&);
    PassRefPtr<Attr> createAttributeNS(const WTF::String& namespaceURI, const WTF::String& qualifiedName, ExceptionCode&, bool shouldIgnoreNamespaceChecks = false);
    PassRefPtr<EntityReference> createEntityReference(const WTF::String& name, ExceptionCode&);
    PassRefPtr<Node> importNode(Node* importedNode, bool deep, ExceptionCode&);
    virtual PassRefPtr<Element> createElementNS(const WTF::String& namespaceURI, const WTF::String& qualifiedName, ExceptionCode&);
    ...
    WTF::String readyState() const;

    WTF::String defaultCharset() const;

    WTF::String inputEncoding() const { return Document::encoding(); }
    WTF::String charset() const { return Document::encoding(); }
    WTF::String characterSet() const { return Document::encoding(); }

    void setCharset(const WTF::String&);

    void setContent(const WTF::String&);

    WTF::String contentLanguage() const { return m_contentLanguage; }
    void setContentLanguage(const WTF::String& lang) { m_contentLanguage = lang; }

    WTF::String xmlEncoding() const { return m_xmlEncoding; }
    WTF::String xmlVersion() const { return m_xmlVersion; }
    bool xmlStandalone() const { return m_xmlStandalone; }

    void setXMLEncoding(const WTF::String& encoding) { m_xmlEncoding = encoding; } // read-only property, only to be set from XMLDocumentParser
    void setXMLVersion(const WTF::String&, ExceptionCode&);
    void setXMLStandalone(bool, ExceptionCode&);

    WTF::String documentURI() const { return m_documentURI; }
    void setDocumentURI(const WTF::String&);
    ...
    PassRefPtr<HTMLCollection> windowNamedItems(const WTF::String& name);
    PassRefPtr<HTMLCollection> documentNamedItems(const WTF::String& name);
    ...
    WTF::Vector<WTF::String> formElementsState() const;
    void setStateForNewFormElements(const WTF::Vector<WTF::String>&);
    bool hasStateForNewFormElements() const;
    bool takeStateForFormElement(AtomicStringImpl* name, AtomicStringImpl* type, WTF::String& state);
    ...
    PassRefPtr<EditingText> createEditingTextNode(const WTF::String&);
    ...
    void write(const WTF::String& text, Document* ownerDocument = 0);
    void writeln(const WTF::String& text, Document* ownerDocument = 0);
    void finishParsing();
    ...
    const WTF::String& baseTarget() const { return m_baseTarget; }
    void processBaseElement();

    KURL completeURL(const WTF::String&) const;

    virtual WTF::String userAgent(const KURL&) const;

    CSSStyleSheet* pageUserSheet();
    void clearPageUserSheet();
    void updatePageUserSheet();

    const WTF::Vector<RefPtr<CSSStyleSheet> >* pageGroupUserSheets() const;
    ...
    /* Newly proposed CSS3 mechanism for selecting alternate
       ...
       spec matures. - dwh
    */
    WTF::String preferredStylesheetSet() const;
    WTF::String selectedStylesheetSet() const;
    void setSelectedStylesheetSet(const WTF::String&);

    bool setFocusedNode(PassRefPtr<Node>);
    Node* focusedNode() const { return m_focusedNode.get(); }

    void getFocusableNodes(WTF::Vector<RefPtr<Node> >&);
    ...
    PassRefPtr<Event> createEvent(const WTF::String& eventType, ExceptionCode&);
    ...
    CSSStyleDeclaration* getOverrideStyle(Element*, const WTF::String& pseudoElt);
     ...
     */
    void processHttpEquiv(const WTF::String& equiv, const WTF::String& content);
    void processViewport(const WTF::String& features);

#ifdef ANDROID_META_SUPPORT
     /**
      * Handles format-detection like <meta name = "format-detection" content = "telephone=no">
      */
     void processMetadataSettings(const WTF::String& content);
#endif
    ...
    WTF::String title() const { return m_title.string(); }
    void setTitle(const WTF::String&);

    void setTitleElement(const StringWithDirection&, Element* titleElement);
    void removeTitle(Element* titleElement);

    WTF::String cookie(ExceptionCode&) const;
    void setCookie(const WTF::String&, ExceptionCode&);

    WTF::String referrer() const;

    WTF::String domain() const;
    void setDomain(const WTF::String& newDomain, ExceptionCode&);

    WTF::String lastModified() const;
    ...
    static bool isValidName(const WTF::String&);

    // The following breaks a qualified name into a prefix and a local name.
    // It also does a validity check, and returns false if the qualified name
    // is invalid.  It also sets ExceptionCode when name is invalid.
    static bool parseQualifiedName(const WTF::String& qualifiedName, WTF::String& prefix, WTF::String& localName, ExceptionCode&);
    ...
    bool execCommand(const WTF::String& command, bool userInterface = false, const WTF::String& value = WTF::String());
    bool queryCommandEnabled(const WTF::String& command);
    bool queryCommandIndeterm(const WTF::String& command);
    bool queryCommandState(const WTF::String& command);
    bool queryCommandSupported(const WTF::String& command);
    WTF::String queryCommandValue(const WTF::String& command);
    ...
    PassRefPtr<XPathExpression> createExpression(const WTF::String& expression,
                                                 XPathNSResolver* resolver,
                                                 ExceptionCode& ec);
    PassRefPtr<XPathNSResolver> createNSResolver(Node *nodeResolver);
    PassRefPtr<XPathResult> evaluate(const WTF::String& expression,
                                     Node* contextNode,
                                     XPathNSResolver* resolver,
                                     unsigned short type,
                                     XPathResult* result,
    ...
    const WTF::String& iconURL() const { return m_iconURL; }
    void setIconURL(const WTF::String& iconURL, const WTF::String& type);
    ...
    CanvasRenderingContext* getCSSCanvasContext(const WTF::String& type, const WTF::String& name, int width, int height);
    HTMLCanvasElement* getCSSCanvasElement(const WTF::String& name);

    bool isDNSPrefetchEnabled() const { return m_isDNSPrefetchEnabled; }
    void parseDNSPrefetchControlHeader(const WTF::String&);

    virtual void addMessage(MessageSource, MessageType, MessageLevel, const WTF::String& message, unsigned lineNumber, const WTF::String& sourceURL, PassRefPtr<ScriptCallStack>);
    ...
    WTF::String displayStringModifiedByEncoding(const WTF::String&) const;
    ...
    const WTF::Vector<DashboardRegionValue>& dashboardRegions() const;
    void setDashboardRegions(const WTF::Vector<DashboardRegionValue>&);
#endif
    ...
    virtual void databaseExceededQuota(const WTF::String& name);
#endif
    ...
    void enqueueHashchangeEvent(const WTF::String& oldURL, const WTF::String& newURL);
    ...
    virtual void logExceptionToConsole(const WTF::String& errorMessage, int lineNumber, const WTF::String& sourceURL, PassRefPtr<ScriptCallStack>);
...
protected:
    ...
    void clearXMLVersion() { m_xmlVersion = WTF::String(); }
...
private:
    ...
    typedef void (*ArgumentsCallback)(const WTF::String& keyString, const WTF::String& valueString, Document*, void* data);
    void processArguments(const WTF::String& features, void* data, ArgumentsCallback);

    virtual bool isDocument() const { return true; }

    virtual void childrenChanged(bool changedByParser = false, Node* beforeChange = 0, Node* afterChange = 0, int childCountDelta = 0);

    virtual WTF::String nodeName() const;
    ...
    virtual KURL virtualCompleteURL(const WTF::String&) const; // Same as completeURL() for the same reason as above.

    virtual double minimumTimerInterval() const;

    WTF::String encoding() const;
    ...
    WTF::Vector<OwnPtr<FontData> > m_retiredCustomFonts;
    ...
    // takes precedence.
    WTF::String m_documentURI;

    WTF::String m_baseTarget;
    ...
    mutable OwnPtr<WTF::Vector<RefPtr<CSSStyleSheet> > > m_pageGroupUserSheets;
    ...
    WTF::HashSet<NodeIterator*> m_nodeIterators;
    WTF::HashSet<Range*> m_ranges;
    ...
    typedef WTF::HashMap<FormElementKey, WTF::Vector<WTF::String>, FormElementKeyHash, FormElementKeyHashTraits> FormElementStateMap;
    ...
    WTF::String m_preferredStylesheetSet;
    WTF::String m_selectedStylesheetSet;
    ...
    WTF::String m_xmlEncoding;
    WTF::String m_xmlVersion;
    bool m_xmlStandalone;

    WTF::String m_contentLanguage;
    ...
    typedef WTF::HashMap<AtomicStringImpl*, CollectionCache*> NamedCollectionMap;
...
#if ENABLE(DASHBOARD_SUPPORT)
    WTF::Vector<DashboardRegionValue> m_dashboardRegions;
    bool m_hasDashboardRegions;
    bool m_dashboardRegionsDirty;
#endif

    WTF::HashMap<WTF::String, RefPtr<HTMLCanvasElement> > m_cssCanvasElements;

    bool m_createRenderers;
    bool m_inPageCache;
    WTF::String m_iconURL;

    WTF::HashSet<Element*> m_documentActivationCallbackElements;
    WTF::HashSet<Element*> m_mediaVolumeCallbackElements;
    WTF::HashSet<Element*> m_privateBrowsingStateChangedElements;
    ...
    WTF::HashSet<MediaCanStartListener*> m_mediaCanStartListeners;
