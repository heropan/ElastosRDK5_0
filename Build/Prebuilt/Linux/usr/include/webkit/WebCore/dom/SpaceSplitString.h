...
namespace WebCore {
    ...
    public:
        SpaceSplitStringData(const WTF::String& string, bool shouldFoldCase)
    ...
    private:
        ...
        typedef WTF::Vector<AtomicString, 8> StringVector;
        WTF::String m_string;
    ...
    public:
        SpaceSplitString() { }
        SpaceSplitString(const WTF::String& string, bool shouldFoldCase) : m_data(adoptPtr(new SpaceSplitStringData(string, shouldFoldCase))) { }

        void set(const WTF::String& string, bool shouldFoldCase) { m_data = adoptPtr(new SpaceSplitStringData(string, shouldFoldCase)); }
