...
public:
    ...
    void detach();
    void addMarker(Range*, DocumentMarker::MarkerType, WTF::String description = WTF::String());
    ...
    WTF::Vector<DocumentMarker> markersForNode(Node*);
    WTF::Vector<DocumentMarker> markersInRange(Range*, DocumentMarker::MarkerType);
    WTF::Vector<IntRect> renderedRectsForMarkers(DocumentMarker::MarkerType);
...
private:
    typedef std::pair<WTF::Vector<DocumentMarker>, WTF::Vector<IntRect> > MarkerMapVectorPair;
    typedef WTF::HashMap<RefPtr<Node>, MarkerMapVectorPair*> MarkerMap;
