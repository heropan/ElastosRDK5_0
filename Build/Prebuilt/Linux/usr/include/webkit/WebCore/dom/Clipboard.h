...
namespace WebCore {
    ...
    public:
        ...
        WTF::String dropEffect() const { return dropEffectIsUninitialized() ? "none" : m_dropEffect; }
        void setDropEffect(const WTF::String&);
        bool dropEffectIsUninitialized() const { return m_dropEffect == "uninitialized"; }
        WTF::String effectAllowed() const { return m_effectAllowed; }
        void setEffectAllowed(const WTF::String&);

        virtual void clearData(const WTF::String& type) = 0;
        virtual void clearAllData() = 0;
        virtual WTF::String getData(const WTF::String& type, bool& success) const = 0;
        virtual bool setData(const WTF::String& type, const WTF::String& data) = 0;

        // extensions beyond IE's API
        virtual WTF::HashSet<WTF::String> types() const = 0;
        ...
        virtual void declareAndWriteDragImage(Element*, const KURL&, const WTF::String& title, Frame*) = 0;
#endif
        virtual void writeURL(const KURL&, const WTF::String&, Frame*) = 0;
        virtual void writeRange(Range*, Frame*) = 0;
        virtual void writePlainText(const WTF::String&) = 0;
    ...
    private:
        ...
        WTF::String m_dropEffect;
        WTF::String m_effectAllowed;
        bool m_dragStarted;
