...
public:
    ...
    void removeAnimationsForKeyframes(const WTF::String& name);
    ...
    */
    ...
    friend void Elastos::Droid::Webkit::Native::SerializeLayer(LayerAndroid* layer, SkWStream* stream);
    friend LayerAndroid* Elastos::Droid::Webkit::Native::DeserializeLayer(int version, SkStream* stream);
...
private:
    ...
    void collect3dRenderingContext(WTF::Vector<LayerAndroid*>& layersInContext);
...
private:
    ...
    typedef WTF::HashMap<pair<WTF::String, int>, RefPtr<AndroidAnimation> > KeyframesMap;
