...
public:
    ...
    virtual WTF::String itemText(unsigned listIndex) const = 0;
    virtual WTF::String itemLabel(unsigned listIndex) const = 0;
    virtual WTF::String itemIcon(unsigned listIndex) const = 0;
    virtual WTF::String itemToolTip(unsigned listIndex) const = 0;
    virtual WTF::String itemAccessibilityText(unsigned listIndex) const = 0;
