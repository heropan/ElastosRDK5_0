...
public:
    ...
    float width(const TextRun&, WTF::HashSet<const SimpleFontData*>* fallbackFonts = 0, GlyphOverflow* = 0) const;
    float width(const TextRun&, int extraCharsAvailable, int& charsConsumed, WTF::String& glyphName) const;
...
private:
    ...
    float floatWidthUsingSVGFont(const TextRun&, int extraCharsAvailable, int& charsConsumed, WTF::String& glyphName) const;
...
private:
    ...
    float floatWidthForSimpleText(const TextRun&, GlyphBuffer*, WTF::HashSet<const SimpleFontData*>* fallbackFonts = 0, GlyphOverflow* = 0) const;
    ...
    float floatWidthForComplexText(const TextRun&, WTF::HashSet<const SimpleFontData*>* fallbackFonts = 0, GlyphOverflow* = 0) const;
...
public:
    ...
    static WTF::String normalizeSpaces(const UChar*, unsigned length);
