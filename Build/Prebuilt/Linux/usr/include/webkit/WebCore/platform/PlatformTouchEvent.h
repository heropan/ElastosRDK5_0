...
public:
    ...
    PlatformTouchEvent(const WTF::Vector<int>&, const WTF::Vector<IntPoint>&, TouchEventType, const WTF::Vector<PlatformTouchPoint::State>&, int metaState);
    ...
    const WTF::Vector<PlatformTouchPoint>& touchPoints() const { return m_touchPoints; }
...
protected:
    ...
    WTF::Vector<PlatformTouchPoint> m_touchPoints;
    bool m_ctrlKey;
    bool m_altKey;
    bool m_shiftKey;
    bool m_metaKey;
