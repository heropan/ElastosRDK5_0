...
namespace JSC {
    ...
    public:
        ...
        WTF::HashSet<MarkedArgumentBuffer*>& markListSet() { if (!m_markListSet) m_markListSet = new WTF::HashSet<MarkedArgumentBuffer*>; return *m_markListSet; }
    ...
    private:
        ...
        WTF::HashSet<MarkedArgumentBuffer*>* m_markListSet;
