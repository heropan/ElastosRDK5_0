...
public:
    ...
    static UString adopt(WTF::Vector<UChar, inlineCapacity>& vector) { return StringImpl::adopt(vector); }
    ...
    WTF::CString ascii() const;
    WTF::CString latin1() const;
    WTF::CString utf8(bool strict = false) const;
