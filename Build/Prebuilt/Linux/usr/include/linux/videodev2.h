...
/* WARNING: DO NOT EDIT, AUTO-GENERATED CODE - SEE TOP FOR INSTRUCTIONS */
enum v4l2_white_balance_temperature {
	V4L2_WHITE_BALANCE_INCANDESCENT		= 0,
	V4L2_WHITE_BALANCE_FLUORESCENT		= 1,
	V4L2_WHITE_BALANCE_DAYLIGHT			= 2,
	V4L2_WHITE_BALANCE_CLOUDY_DAYLIGHT  = 3,
	V4L2_WHITE_BALANCE_WARM_FLUORESCENT	= 4,
	V4L2_WHITE_BALANCE_TWILIGHT			= 5,
	V4L2_WHITE_BALANCE_SHADE			= 6,
};
...
#define V4L2_CID_PRIVATE_PREV_CAPT	(V4L2_CID_CAMERA_CLASS_BASE+20)
