...
int usb_device_claim_interface(struct usb_device *device, unsigned int interfaceId);

/* Releases the specified interface of a USB device */
int usb_device_release_interface(struct usb_device *device, unsigned int interfaceId);
...
int usb_device_connect_kernel_driver(struct usb_device *device,
        unsigned int interfaceId, int connect);
