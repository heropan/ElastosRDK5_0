    ...
    /* [in] */ ISurfaceHolder* holder)
{
    ...
    DBG_LOG("\t + MySurfaceHoderCallback::SurfaceCreated()");
...
ECode CGeckoSurfaceView::MySurfaceHoderCallback::SurfaceChanged(
    ...
    /* [in] */ Int32 height)
{
    DBG_LOG("\t + MySurfaceHoderCallback::SurfaceChanged()");
#if (DBG)
    Logger::D(DBG_TAG, "\t \t format: %d, width: %d, height: %d", format, width, height);
#endif
    ...
    if (mHost->mDrawMode == DRAW_GLES_2 &&
        ...
        //printf("\t SDK_INIT < HONEYCOMB, Need draw once\n");
    ...
    if (width == 0 || height == 0) {
        // printf("\t Clean bitmap and buffer\n");
    ...
    Int32 widthPixels = metrics->mWidthPixels;
    Int32 heightPixels = metrics->mHeightPixels;
    */
    Int32 widthPixels = 1280;
    Int32 heightPixels = 695;
    ...
    if (doSyncDraw) {
        ...
        // printf("\t Make sure s frame is drawn \n");
    ...
    /* [in] */ ISurfaceHolder* pHolder)
{
    ...
    DBG_LOG("\t + MySurfaceHoderCallback::SurfaceDestroyed()");
...
ECode CGeckoSurfaceView::MyTouchDelegate::OnTouchEvent(
    ...
    /* [out] */ Boolean* result)
{
    DBG_LOG("\t + MyTouchDelegate::OnTouchEvent()");
...
ECode CGeckoSurfaceView::constructor(
    /* [in] */ IContext* context)
{
    DBG_LOG("\t + CGeckoSurfaceView::constructor()");
...
CGeckoSurfaceView::CGeckoSurfaceView()
    ...
    , mSurfaceView(NULL)
{
    DBG_LOG("\t + CGeckoSurfaceView::CGeckoSurfaceView()");
...
{
    DBG_LOG("\t + CGeckoSurfaceView::DrawSplashScreen()");
    AutoPtr<ISurfaceHolder> holder;
    ASSERT_SUCCEEDED(GetHolder((ISurfaceHolder**)&holder));
...
ECode CGeckoSurfaceView::DrawSplashScreen(
    ...
    /* [in] */ Int32 height)
{
    DBG_LOG("\t + CGeckoSurfaceView::DrawSpashScreen(holder, width, height)");
...
ECode CGeckoSurfaceView::Draw(
    ...
    /* [in] */ IBuffer* pBuffer)
{
    DBG_LOG("\t + CGeckoSurfaceView::Draw(holder, pBuffer)");
    if (!pHolder || !pBuffer) {
        return E_INVALID_ARGUMENT;
    }
    Int32 capacity;
...
ECode CGeckoSurfaceView::Draw(
    ...
    /* [in] */ IBitmap* bitmap)
{
    DBG_LOG("\t + CGeckoSurfaceView::Draw(holder, bitmap)");
    if (!holder || !bitmap) {
        return NOERROR;
    }
    Int32 width, height;
    ...
    /* [out] */IBitmap** bitmap)
{
    ...
    if (mSoftwareBitmap) {
        ...
        // printf("\t Is software bitmap, width: %d, height: %d\n", width, height);
    }
...
{
    DBG_LOG("\t + CGeckoSurfaceView::GetSurface(ppSurface)");
...
ECode CGeckoSurfaceView::BeginDrawing(
    /* [out] */ Int32* result)
{
    DBG_LOG("\t + CGeckoSurfaceView::BeginDrawing(result)");
    VALIDATE_NOT_NULL(result);
...
{
    DBG_LOG("\t + CGeckoSurfaceView::EndDrawing()");
    if (!mInDrawing) {
...
ECode CGeckoSurfaceView::Draw2D(
    ...
    /* [in] */ Int32 height)
{
    DBG_LOG("\t + CGeckoSurfaceView::Draw2D(bitmap, width, height)");
    VALIDATE_NOT_NULL(bitmap);
...
ECode CGeckoSurfaceView::Draw2D(
    ...
    /* [in] */ Int32 stride)
{
    DBG_LOG("\t + CGeckoSurfaceView::Draw2D(pBuffer, stride)");
    assert(0);
...
ECode CGeckoSurfaceView::OnCheckIsTextEditor(
    /* [out] */ Boolean * pResult)
{
    DBG_LOG("\t + CGeckoSurfaceView::OnCheckIsTextEditor");
    *pResult = FALSE;
    DBG_LOG("\t - CGeckoSurfaceView::OnCheckIsTextEditor");
    return NOERROR;
}
...
{
    DBG_LOG("\t + CGeckoSurfaceView::SetEditable()");
...
ECode CGeckoSurfaceView::InitEditable(
    /* [in] */ ICharSequence* contents)
{
    DBG_LOG("\t + CGeckoSurfaceView::InitEditable()");
...
{
    DBG_LOG("\t + CGeckoSurfaceView::SetOnCreateContextMenuListener()");
    ECode result = mSurfaceView->SetOnCreateContextMenuListener(pL);
#if (DBG)
    Logger::D(DBG_TAG, "\t \t Result: %d", result);
#endif
    DBG_LOG("\t - CGeckoSurfaceView::SetOnCreateContextMenuListener()");
    return result;
}
    ...
    /* [out] */ Boolean * pResult)
{
    ...
    ECode result = mSurfaceView->ShowContextMenu(pResult);
    #if (DBG)
    Logger::D(DBG_TAG, "\t \t Result: %d", result);
    #endif
    DBG_LOG("\t - CGeckoSurfaceView::ShowContextMenu()");
...
ECode CGeckoSurfaceView::OnKeyPreIme(
    ...
    /* [out] */ Boolean* result)
{
    DBG_LOG("\t + CGeckoSurfaceView::OnKeyPreIme()");
    VALIDATE_NOT_NULL(result);
...
ECode CGeckoSurfaceView::ProcessKeyDown(
    ...
    /* [out] */ Boolean* result)
{
    DBG_LOG("\t + CGeckoSurfaceView::ProcessKeyDown()");
    VALIDATE_NOT_NULL(result);
    DBG_LOG("\t \t verify param pass");
    ...
    switch (keyCode) {
        case IKeyEvent::KEYCODE_BACK: {
            ...
            if (count == 0) {
                event->StartTracking();
                *result = TRUE;
        DBG_LOG("\t \t KEY_BACK, TRUE");
                return NOERROR;
            }
            else {
        DBG_LOG("\t \t KEY_BACK, FALSE");
                *result = FALSE;
                return NOERROR;
            }
        }
    ...
    if (isPreIme && mIMEState != IME_STATE_DISABLED &&
        ...
        *result = FALSE;
    DBG_LOG("\t \t Let active IME process");
        return NOERROR;
    }
...
ECode CGeckoSurfaceView::OnKeyLongPress(
    ...
    /* [out] */ Boolean* pResult)
{
    DBG_LOG("\t + CGeckoSurfaceView::OnKeyLongPress()");
    ECode ec;
    ...
    switch (keyCode) {
        ...
        DBG_LOG("\t \t get Binder");
            ...
            if (FAILED(ec)) return ec;
        DBG_LOG("\t \t Get softInputFromWindow");
            *pResult = TRUE;
            return NOERROR;
        }
        default:
...
ECode CGeckoSurfaceView::ProcessKeyUp(
    ...
    /* [in] */ Boolean isPreIme,
    /* [out] */ Boolean* pResult) {
    DBG_LOG("\t + CGeckoSurfaceView::ProcessKeyUp()");
    switch (keyCode) {
        case IKeyEvent::KEYCODE_BACK:
            Boolean isTracking;
            Boolean isCanceled;
...
ECode CGeckoSurfaceView::OnKeyMultiple(
    ...
    /* [out] */ Boolean* pResult)
{
    DBG_LOG("\t + CGeckoSurfaceView::OnKeyMultiple()");
    GeckoEvent* pGeckoEvent = new GeckoEvent(pEvent);
    if (!pGeckoEvent) return E_OUT_OF_MEMORY;
    GeckoAppShell::SendEventToGecko(pGeckoEvent);
...
{
    DBG_LOG("\t + CGeckoSurfaceView::OnCreateInputConnection()");
...
ECode CGeckoSurfaceView::OnTouchEvent(
    ...
    /* [out] */ Boolean* result)
{
    DBG_LOG("\t + CGeckoSurfaceView::OnTouchEvent()");
    if ((NULL == event) || (NULL == result)) {
        Logger::D(DBG_TAG, "OnTouchEvent() params is invalid");
        return NOERROR;
    }
    ...
    Int32 action = 0;
    event->GetAction(&action);
    Logger::D(DBG_TAG, "TouchEvent type: %d", action);
#endif
    AutoPtr<GeckoEvent> geckoEvent = new GeckoEvent(event);
    GeckoAppShell::SendEventToGecko(geckoEvent);
    *result = TRUE;
...
ECode CGeckoSurfaceView::SetTagInternal(
    ...
    /* [in] */ IInterface* tag)
{
    return mSurfaceView->SetTagInternal(key, tag);
}
