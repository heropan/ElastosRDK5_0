    ...
    /* [in] */ IMotionEvent* event)
{
    ...
    if (Build::VERSION::SDK_INT >= 9) {
        ...
        size = size * Elastos::Core::Math::Min(heightPixels, widthPixels);
    ...
    , mNativeWindow(0)
{
    ...
    mPoints = ArrayOf<IPoint*>::Alloc(3);
