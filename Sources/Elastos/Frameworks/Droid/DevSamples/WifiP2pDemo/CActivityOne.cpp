...
using Elastos::Droid::Net::Wifi::P2p::IWifiP2pWfdInfo;
using Elastos::Droid::Net::Wifi::P2p::CWifiP2pWfdInfo;
...
using Elastos::Droid::Net::Wifi::P2p::EIID_IWifiP2pManagerGroupInfoListener;
