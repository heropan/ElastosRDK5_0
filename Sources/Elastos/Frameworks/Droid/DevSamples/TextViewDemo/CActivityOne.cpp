...
using Elastos::Droid::Net::Wifi::CWifiConfiguration;
using Elastos::Droid::Net::Wifi::IWifiConfigurationGroupCipher;
using Elastos::Droid::Net::Wifi::IWifiConfigurationKeyMgmt;
using Elastos::Droid::Net::Wifi::IWifiConfigurationPairwiseCipher;
using Elastos::Droid::Net::Wifi::IWifiConfigurationProtocol;
