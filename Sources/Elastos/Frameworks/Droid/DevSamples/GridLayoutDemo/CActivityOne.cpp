        ...
        /* [in] */ IBundle* savedInstanceState)
{
    ...
    Slogger::D("jiazhenjiang", "Address of mActionBar2 %p", mActionBar.Get());
    //mActionBar->Show();
    AutoPtr<IView> layout = FindViewById(R::id::layout);
    mLayout = IGridLayout::Probe(layout);
    Int32 rowCount = 0, columnCount;
    mLayout->GetRowCount(&rowCount);
    mLayout->GetColumnCount(&columnCount);
    Slogger::D(String("JZJTEST"), "value of rowCount : %d, columnCount : %d", rowCount, columnCount);
