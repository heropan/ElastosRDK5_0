...
#include "droid/test/CInstrumentationTestRunner.h"
...
//=================================================================
CAR_INTERFACE_IMPL(CInstrumentationTestRunner::SuiteAssignmentPrinter, ITestListener)
    ...
    /* [in] */ ITest* test)
{
    ...
    sb.AppendCStr("\nin ");
    sb.AppendString(assignmentSuite);
    sb.AppendCStr(" suite\nrunTime: ");
    sb.AppendString(StringUtils::FloatToString(runTime));
    sb.AppendCStr("\n");
...
CAR_INTERFACE_IMPL_2(CInstrumentationTestRunner::WatcherResultPrinter, ITestListener, IPerformanceResultsWriter)
...
//==================================================================
CAR_INTERFACE_IMPL(CInstrumentationTestRunner::TestMethodPredicate, IPredicate)
...
PInterface CInstrumentationTestRunner::Probe(
    /* [in] */ REIID riid)
{
    if (riid == EIID_IInterface) {
        return (PInterface)(IInstrumentation*)this;
    }
    else if (riid == EIID_IObject) {
        return (IObject*)this;
    }
    else if (riid == EIID_IInstrumentationTestRunner) {
        return (IInstrumentationTestRunner*)this;
    }
    else if (riid == EIID_IInstrumentation) {
        return (IInstrumentation*)this;
    }
    else if (riid == EIID_ITestSuiteProvider) {
        return (ITestSuiteProvider*)this;
    }
    return NULL;
}

UInt32 CInstrumentationTestRunner::AddRef()
{
    return ElRefBase::AddRef();
}

UInt32 CInstrumentationTestRunner::Release()
{
    return ElRefBase::Release();
}

ECode CInstrumentationTestRunner::GetInterfaceID(
    ...
    /* [out] */ InterfaceID *pIID)
{
    ...
    else if (pObject == (IInterface *)(ITestSuiteProvider *)this) {
        *pIID = EIID_ITestSuiteProvider;
        return NOERROR;
    }
...
ECode CInstrumentationTestRunner::Aggregate(
...
ECode CInstrumentationTestRunner::GetDomain(
    ...
    /* [in] */ IBundle* arguments)
{
    ...
    if (arguments != NULL) {
        ...
        if (delay != NULL) {
            ...
            ECode ec = StringUtils::ParseInt32(delayStr, &mDelayMsec);
            if (FAILED(ec)) {
    ...
    StringBuf_<512> nameBuf;
    clsInfo->GetName(&nameBuf);
    String clsName((const char*)nameBuf);
    context = NULL;
    GetTargetContext((IContext**)&context);
