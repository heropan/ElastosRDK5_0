...
#ifndef __ELASTOS_DROID_PACKAGES_SYSTEMUI_CBATTERYMETERVIEW_H__
#define __ELASTOS_DROID_PACKAGES_SYSTEMUI_CBATTERYMETERVIEW_H__
...
#endif // __ELASTOS_DROID_PACKAGES_SYSTEMUI_CBATTERYMETERVIEW_H__
