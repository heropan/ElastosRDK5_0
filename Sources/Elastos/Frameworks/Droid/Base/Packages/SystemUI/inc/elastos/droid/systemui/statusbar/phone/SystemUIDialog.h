...
#ifndef  __ELASTOS_DROID_PACKAGES_SYSTEMUI_STATUSBAR_PHONE_SYSTEMUIDIALOG_H__
#define  __ELASTOS_DROID_PACKAGES_SYSTEMUI_STATUSBAR_PHONE_SYSTEMUIDIALOG_H__
...
#endif // __ELASTOS_DROID_PACKAGES_SYSTEMUI_STATUSBAR_PHONE_SYSTEMUIDIALOG_H__
