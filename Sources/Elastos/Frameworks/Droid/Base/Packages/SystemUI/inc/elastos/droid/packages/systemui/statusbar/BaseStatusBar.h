...
using Elastos::Droid::Packages::SystemUI::ISearchPanelView;
using Elastos::Droid::Packages::SystemUI::StatusBar::Phone::INavigationBarView;
using Elastos::Droid::Packages::SystemUI::StatusBar::Phone::IStatusBarKeyguardViewManager;
using Elastos::Droid::Packages::SystemUI::StatusBar::Policy::IHeadsUpNotificationView;
using Elastos::Droid::Packages::SystemUI::StatusBar::Stack::INotificationStackScrollLayout;
