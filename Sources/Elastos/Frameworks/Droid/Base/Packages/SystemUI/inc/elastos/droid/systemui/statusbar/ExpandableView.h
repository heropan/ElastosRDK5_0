...
#ifndef  __ELASTOS_DROID_PACKAGES_SYSTEMUI_STATUSBAR_EXPANDABLEVIEW_H__
#define  __ELASTOS_DROID_PACKAGES_SYSTEMUI_STATUSBAR_EXPANDABLEVIEW_H__
...
#endif // __ELASTOS_DROID_PACKAGES_SYSTEMUI_STATUSBAR_EXPANDABLEVIEW_H__
