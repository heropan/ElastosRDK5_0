...
const Double FakeShadowDrawable::COS_45 = Elastos::Core::Math::Cos(Elastos::Core::Math::ToRadians(45));

const Float FakeShadowDrawable::SHADOW_MULTIPLIER;

FakeShadowDrawable::FakeShadowDrawable(
...
// @Override
ECode FakeShadowDrawable::SetAlpha(
    /* [in] */ Int32 alpha)
{
...
// @Override
void FakeShadowDrawable::OnBoundsChange(
    /* [in] */ IRect* bounds)
{
...
ECode FakeShadowDrawable::SetShadowSize(
    /* [in] */ Float shadowSize,
    /* [in] */ Float maxShadowSize)
{
    if (shadowSize < 0 || maxShadowSize < 0) {
        Logger::E("FakeShadowDrawable", "invalid shadow size");
...
// @Override
ECode FakeShadowDrawable::GetPadding(
    /* [in] */ IRect* padding,
    /* [out] */ Boolean* result)
{
...
Float FakeShadowDrawable::CalculateVerticalPadding(
    /* [in] */ Float maxShadowSize,
...
Float FakeShadowDrawable::CalculateHorizontalPadding(
    /* [in] */ Float maxShadowSize,
    /* [in] */ Float cornerRadius,
    /* [in] */ Boolean addPaddingForCorners)
{
...
// @Override
ECode FakeShadowDrawable::SetColorFilter(
    /* [in] */ IColorFilter* cf)
{
...
// @Override
ECode FakeShadowDrawable::GetOpacity(
    /* [out] */ Int32* opacity)
{
...
void FakeShadowDrawable::DrawShadow(
    /* [in] */ ICanvas* canvas)
{
...
void FakeShadowDrawable::BuildShadowCorners()
{
...
void FakeShadowDrawable::BuildComponents(
    /* [in] */ IRect* bounds)
{
...
Float FakeShadowDrawable::GetMinWidth()
{
...
Float FakeShadowDrawable::GetMinHeight()
{
