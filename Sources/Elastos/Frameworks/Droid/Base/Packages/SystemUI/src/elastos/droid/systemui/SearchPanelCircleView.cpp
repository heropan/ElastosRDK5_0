...
using Elastos::Droid::SystemUI::StatusBar::Phone::PhoneStatusBar;
    ...
    /* [in] */ IValueAnimator* animation)
{
    ...
    ITimeInterpolator::Probe(PhoneStatusBar::ALPHA_OUT)->GetInterpolation(1.0f - logoValue, &logoValue);
    Float backgroundValue;
    ITimeInterpolator::Probe(PhoneStatusBar::ALPHA_OUT)->GetInterpolation(
