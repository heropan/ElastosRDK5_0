...
//-----------------------------------------------------------------------------------------
// KeyguardViewMediator::MyKeyguardUpdateMonitorCallback
//-----------------------------------------------------------------------------------------

CAR_INTERFACE_IMPL(KeyguardViewMediator::MyKeyguardUpdateMonitorCallback, Object, IKeyguardUpdateMonitorCallback)

KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::MyKeyguardUpdateMonitorCallback(
    /* [in] */ KeyguardViewMediator* host)
    : mHost(host)
{}

ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnUserSwitching(
    /* [in] */ Int32 userId)
{
...
ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnUserSwitchComplete(
    /* [in] */ Int32 userId)
{
...
ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnUserRemoved(
    /* [in] */ Int32 userId)
{
...
ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnUserInfoChanged(
    /* [in] */ Int32 userId)
{
#if 0 //TODO
    AutoPtr<IMultiUserAvatarCacheHelper> muach;
...
ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnPhoneStateChanged(
    /* [in] */ Int32 phoneState)
{
    synchronized(mHost) {
...
ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnClockVisibilityChanged()
{
    mHost->AdjustStatusBarLocked();
    return NOERROR;
}

ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnDeviceProvisioned()
{
    mHost->SendUserPresentBroadcast();
    return NOERROR;
}

ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnSimStateChanged(
...
ECode KeyguardViewMediator::MyKeyguardUpdateMonitorCallback::OnFingerprintRecognized(
    /* [in] */ Int32 userId)
{
...
//-----------------------------------------------------------------------------------------
// KeyguardViewMediator::MyViewMediatorCallback
//-----------------------------------------------------------------------------------------

CAR_INTERFACE_IMPL(KeyguardViewMediator::MyViewMediatorCallback, Object, IViewMediatorCallback)

KeyguardViewMediator::MyViewMediatorCallback::MyViewMediatorCallback(
    /* [in] */ KeyguardViewMediator* host)
    : mHost(host)
{}

ECode KeyguardViewMediator::MyViewMediatorCallback::UserActivity()
{
    mHost->UserActivity();
    return NOERROR;
}

ECode KeyguardViewMediator::MyViewMediatorCallback::KeyguardDone(
...
ECode KeyguardViewMediator::MyViewMediatorCallback::KeyguardDoneDrawing()
{
    Boolean result;
    return mHost->mHandler->SendEmptyMessage(KEYGUARD_DONE_DRAWING, &result);
}

ECode KeyguardViewMediator::MyViewMediatorCallback::SetNeedsInput(
    /* [in] */ Boolean needsInput)
{
    return mHost->mStatusBarKeyguardViewManager->SetNeedsInput(needsInput);
}

ECode KeyguardViewMediator::MyViewMediatorCallback::OnUserActivityTimeoutChanged()
{
    return mHost->mStatusBarKeyguardViewManager->UpdateUserActivityTimeout();
}

ECode KeyguardViewMediator::MyViewMediatorCallback::KeyguardDonePending()
{
...
ECode KeyguardViewMediator::MyViewMediatorCallback::KeyguardGone()
{
    //TODO
...
ECode KeyguardViewMediator::MyViewMediatorCallback::ReadyForKeyguardDone()
{
...
ECode KeyguardViewMediator::MyViewMediatorCallback::PlayTrustedSound()
{
...
//-----------------------------------------------------------------------------------------
// KeyguardViewMediator::MyBroadcastReceiver
//-----------------------------------------------------------------------------------------

KeyguardViewMediator::MyBroadcastReceiver::MyBroadcastReceiver(
    /* [in] */ KeyguardViewMediator* host)
    : mHost(host)
{}

ECode KeyguardViewMediator::MyBroadcastReceiver::OnReceive(
    /* [in] */ IContext* context,
    /* [in] */ IIntent* intent)
{
    String action;
...
//-----------------------------------------------------------------------------------------
// KeyguardViewMediator::StartKeyguardExitAnimParams
//-----------------------------------------------------------------------------------------

KeyguardViewMediator::StartKeyguardExitAnimParams::StartKeyguardExitAnimParams(
    /* [in] */ Int64 startTime,
...
//-----------------------------------------------------------------------------------------
// KeyguardViewMediator::MyHandler
//-----------------------------------------------------------------------------------------

KeyguardViewMediator::MyHandler::MyHandler(
    /* [in] */ KeyguardViewMediator* host)
    : Handler(Looper::GetMyLooper(), NULL, TRUE)
    , mHost(host)
{}

ECode KeyguardViewMediator::MyHandler::HandleMessage(
    /* [in] */ IMessage* msg)
{
    Int32 what;
    msg->GetWhat(&what);
...
//-----------------------------------------------------------------------------------------
// KeyguardViewMediator::MyRunnable
//-----------------------------------------------------------------------------------------

KeyguardViewMediator::MyRunnable::MyRunnable(
    /* [in] */ KeyguardViewMediator* host)
    : mHost(host)
{}

ECode KeyguardViewMediator::MyRunnable::Run()
{
...
CAR_INTERFACE_IMPL(KeyguardViewMediator, SystemUI, IKeyguardViewMediator)

const Int32 KeyguardViewMediator::KEYGUARD_DISPLAY_TIMEOUT_DELAY_DEFAULT;
const Boolean KeyguardViewMediator::DEBUG = FALSE;
const Boolean KeyguardViewMediator::DBG_WAKE = FALSE;

const String KeyguardViewMediator::TAG("KeyguardViewMediator");

const String KeyguardViewMediator::DELAYED_KEYGUARD_ACTION("com.android.internal.policy.impl.PhoneWindowManager.DELAYED_KEYGUARD");

const Int32 KeyguardViewMediator::SHOW;
const Int32 KeyguardViewMediator::HIDE;
const Int32 KeyguardViewMediator::RESET;
const Int32 KeyguardViewMediator::VERIFY_UNLOCK;
const Int32 KeyguardViewMediator::NOTIFY_SCREEN_OFF;
const Int32 KeyguardViewMediator::NOTIFY_SCREEN_ON;
const Int32 KeyguardViewMediator::KEYGUARD_DONE;
const Int32 KeyguardViewMediator::KEYGUARD_DONE_DRAWING;
const Int32 KeyguardViewMediator::KEYGUARD_DONE_AUTHENTICATING;
const Int32 KeyguardViewMediator::SET_OCCLUDED;
const Int32 KeyguardViewMediator::KEYGUARD_TIMEOUT;
const Int32 KeyguardViewMediator::DISMISS;
const Int32 KeyguardViewMediator::START_KEYGUARD_EXIT_ANIM;
const Int32 KeyguardViewMediator::ON_ACTIVITY_DRAWN;

const Int32 KeyguardViewMediator::AWAKE_INTERVAL_DEFAULT_MS;

const Int32 KeyguardViewMediator::KEYGUARD_LOCK_AFTER_DELAY_DEFAULT;

const Int32 KeyguardViewMediator::KEYGUARD_DONE_DRAWING_TIMEOUT_MS;

const String KeyguardViewMediator::KEYGUARD_ANALYTICS_SETTING("keyguard_analytics");
...
AutoPtr<IIntent> KeyguardViewMediator::USER_PRESENT_INTENT = InitUPI();
...
ECode KeyguardViewMediator::UserActivity()
{
    mPM->UserActivity(SystemClock::GetUptimeMillis(), FALSE);
    return NOERROR;
}

void KeyguardViewMediator::Setup()
{
    AutoPtr<IInterface> obj;
...
ECode KeyguardViewMediator::OnSystemReady()
{
    AutoPtr<IInterface> obj;
...
ECode KeyguardViewMediator::OnScreenTurnedOff(
    /* [in] */ Int32 why)
{
    synchronized(this) {
        mScreenOn = FALSE;
...
void KeyguardViewMediator::DoKeyguardLaterLocked()
{
...
void KeyguardViewMediator::CancelDoKeyguardLaterLocked()
{
    mDelayedShowingSequence++;
}

ECode KeyguardViewMediator::OnScreenTurnedOn(
...
void KeyguardViewMediator::MaybeSendUserPresentBroadcast()
{
    Boolean result;
...
ECode KeyguardViewMediator::OnDreamingStarted()
{
    synchronized(this) {
        Boolean isSecure;
        mLockPatternUtils->IsSecure(&isSecure);
...
ECode KeyguardViewMediator::OnDreamingStopped()
{
    synchronized(this) {
        if (mScreenOn) {
            CancelDoKeyguardLaterLocked();
...
ECode KeyguardViewMediator::SetKeyguardEnabled(
    /* [in] */ Boolean enabled)
{
    synchronized(this) {
...
ECode KeyguardViewMediator::VerifyUnlock(
...
ECode KeyguardViewMediator::IsShowing(
...
ECode KeyguardViewMediator::IsOccluded(
...
ECode KeyguardViewMediator::IsShowingAndNotOccluded(
...
ECode KeyguardViewMediator::SetOccluded(
...
void KeyguardViewMediator::HandleSetOccluded(
    /* [in] */ Boolean isOccluded)
{
    synchronized(this) {
...
ECode KeyguardViewMediator::DoKeyguardTimeout(
    /* [in] */ IBundle* options)
{
...
ECode KeyguardViewMediator::IsInputRestricted(
...
void KeyguardViewMediator::DoKeyguardLocked(
    /* [in] */ IBundle* options)
{
...
ECode KeyguardViewMediator::HandleDismiss()
{
...
ECode KeyguardViewMediator::Dismiss()
{
    Boolean result;
...
void KeyguardViewMediator::ResetStateLocked()
{
...
void KeyguardViewMediator::VerifyUnlockLocked()
{
...
void KeyguardViewMediator::NotifyScreenOffLocked()
{
...
void KeyguardViewMediator::NotifyScreenOnLocked(
...
void KeyguardViewMediator::ShowLocked(
    /* [in] */ IBundle* options)
{
...
void KeyguardViewMediator::HideLocked()
{
...
ECode KeyguardViewMediator::IsSecure(
...
ECode KeyguardViewMediator::SetCurrentUser(
    /* [in] */ Int32 newUserId)
{
    return mLockPatternUtils->SetCurrentUser(newUserId);
}

ECode KeyguardViewMediator::KeyguardDone(
    /* [in] */ Boolean authenticated,
    /* [in] */ Boolean wakeup)
{
...
void KeyguardViewMediator::HandleKeyguardDone(
    /* [in] */ Boolean authenticated,
    /* [in] */ Boolean wakeup)
{
...
void KeyguardViewMediator::SendUserPresentBroadcast()
{
    synchronized(this) {
        if (mBootCompleted) {
            Int32 user;
...
void KeyguardViewMediator::HandleKeyguardDoneDrawing()
{
    synchronized(this) {
...
void KeyguardViewMediator::PlaySounds(
    /* [in] */ Boolean locked)
{
...
void KeyguardViewMediator::PlaySound(
    /* [in] */ Int32 soundId)
{
    if (soundId == 0) return;
    AutoPtr<IContentResolver> resolver;
...
void KeyguardViewMediator::PlayTrustedSound()
{
    if (mSuppressNextLockSound) {
        return;
    }
...
void KeyguardViewMediator::UpdateActivityLockScreenState()
{
...
void KeyguardViewMediator::HandleShow(
    /* [in] */ IBundle* options)
{
    synchronized(this) {
        if (!mSystemReady) {
...
void KeyguardViewMediator::HandleHide()
{
    synchronized (this){
...
void KeyguardViewMediator::HandleOnActivityDrawn()
{
...
void KeyguardViewMediator::HandleStartKeyguardExitAnimation(
    /* [in] */ Int64 startTime,
    /* [in] */ Int64 fadeoutDuration)
{
    synchronized(this) {
...
void KeyguardViewMediator::AdjustStatusBarLocked()
{
...
void KeyguardViewMediator::HandleReset()
{
    synchronized(this) {
...
void KeyguardViewMediator::HandleVerifyUnlock()
{
    synchronized(this) {
...
void KeyguardViewMediator::HandleNotifyScreenOff()
{
    synchronized(this) {
...
void KeyguardViewMediator::HandleNotifyScreenOn(
    /* [in] */ IIKeyguardShowCallback* callback)
{
    synchronized(this) {
...
ECode KeyguardViewMediator::IsDismissable(
...
Boolean KeyguardViewMediator::IsAssistantAvailable()
{
    AutoPtr<IIntent> intent;
...
ECode KeyguardViewMediator::OnBootCompleted()
{
    //TODO
...
ECode KeyguardViewMediator::RegisterStatusBar(
...
ECode KeyguardViewMediator::StartKeyguardExitAnimation(
    /* [in] */ Int64 startTime,
    /* [in] */ Int64 fadeoutDuration)
{
    //TODO
...
ECode KeyguardViewMediator::OnActivityDrawn()
{
    Boolean b;
...
ECode KeyguardViewMediator::GetViewMediatorCallback(
