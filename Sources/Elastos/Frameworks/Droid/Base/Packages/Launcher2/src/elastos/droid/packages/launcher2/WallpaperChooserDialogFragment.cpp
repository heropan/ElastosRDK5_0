    ...
    /* [out] */ IView** outView)
{
    ...
    *outView = NULL;
    ...
    if (convertView == NULL) {
        mLayoutInflater->Inflate(Elastos::Droid::Packages::Launcher2::R::layout::wallpaper_item, parent,
                FALSE, (IView**)&view);
    }
    else {
        view = convertView;
    ...
    AutoPtr<IView> tmp;
    view->FindViewById(Elastos::Droid::Packages::Launcher2::R::id::wallpaper_image, (IView**)&tmp);
    ...
    /* [out] */ IView** outView)
{
    ...
    *outView = NULL;
    ...
    if (mEmbedded) {
        AutoPtr<IView> view;
        inflater->Inflate(Elastos::Droid::Packages::Launcher2::R::layout::wallpaper_chooser, container, FALSE);

        view->SetBackground(mWallpaperDrawable);

        AutoPtr<IView> tmp;
        view->FindViewById(Elastos::Droid::Packages::Launcher2::R::id::gallery, (IView**)&tmp);
        ...
        view->FindViewById(Elastos::Droid::Packages::Launcher2::R::id::set, (IView**)&setButton);
...
void WallpaperChooserDialogFragment::FindWallpapers()
{
    ...
    String packageName;
    resources->GetResourcePackageName(Elastos::Droid::Packages::Launcher2::R::array::wallpapers, &packageName);

    AddWallpapers(resources, packageName, Elastos::Droid::Packages::Launcher2::R::array::wallpapers);
    AddWallpapers(resources, packageName, Elastos::Droid::Packages::Launcher2::R::array::extra_wallpapers);
    return;
}
