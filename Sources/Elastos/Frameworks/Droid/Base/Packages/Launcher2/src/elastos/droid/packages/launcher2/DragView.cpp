...
#include "elastos/droid/packages/launcher2/DragView.h"
    ...
    , mInitialScale(1f)
{
    ...
    Float offsetX;
    res->GetDimensionPixelSize(Elastos::Droid::Packages::Launcher2::R::dimen::dragViewOffsetX, &offsetX);
    Float offsetY;
    res->GetDimensionPixelSize(Elastos::Droid::Packages::Launcher2::R::dimen::dragViewOffsetY, &offsetY);
    Float scaleDps;
    res->GetDimensionPixelSize(Elastos::Droid::Packages::Launcher2::R::dimen::dragViewScale, &scaleDps);
