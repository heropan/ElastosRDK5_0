...
#include "elastos/droid/packages/launcher2/LauncherAppWidgetHostView.h"
    ...
    /* [out] */ IView** view)
{
    ...
    return mInflater->Inflate(Elastos::Droid::Packages::Launcher2::R::layout::appwidget_error,
            this, FALSE, view);
}
