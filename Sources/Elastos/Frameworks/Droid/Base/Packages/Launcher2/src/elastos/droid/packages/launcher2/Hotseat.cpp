...
#include "elastos/droid/packages/launcher2/Hotseat.h"
    ...
    /* [in] */ Int32 defStyle)
{
    ...
    context->ObtainStyledAttributes(attrs,
            Elastos::Droid::Packages::Launcher2::R::styleable::Hotseat,
            defStyle, 0, (ITypedArray**)&a);
    AutoPtr<IResources> r;
    context->GetResources((IResources**)&r);
    a->GetInt32(Elastos::Droid::Packages::Launcher2::R::styleable::Hotseat_cellCountX,
            -1, &mCellCountX);
    a->GetInt32(Elastos::Droid::Packages::Launcher2::R::styleable::Hotseat_cellCountY,
            -1, &mCellCountY);
    r->GetInteger(Elastos::Droid::Packages::Launcher2::R::integer::hotseat_all_apps_index,
            &mAllAppsButtonRank);
    r->GetBoolean(Elastos::Droid::Packages::Launcher2::R::bool::
...
ECode Hotseat::OnFinishInflate()
{
    ...
    AutoPtr<IView> view;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::layout, (IView**)&view);
...
ECode Hotseat::ResetLayout()
{
    ...
    AutoPtr<IView> view;
    inflater->Inflate(Elastos::Droid::Packages::Launcher2::R::layout::application,
    ...
    r->GetDrawable(Elastos::Droid::Packages::Launcher2::R::
    ...
    String lable;
    context->GetString(Elastos::Droid::Packages::Launcher2::R::
