...
#include "elastos/droid/packages/launcher2/CheckLongPressHelper.h"
    ...
    , mRevealRadius(0.0f)
{
    ...
    context->ObtainStyledAttributes(attrs, Elastos::Droid::Packages::Launcher2::R::styleable::Cling,
            defStyle, 0, (ITypedArray**)&a);
    a->GetString(Elastos::Droid::Packages::Launcher2::R::styleable::Cling_drawIdentifier, mDrawIdentifier);
    a->Recycle();
    ...
    /* [in] */ ArrayOf<Int32>* positionData)
{
    if (!mIsInitialized) {
        ...
        r->GetDrawable(Elastos::Droid::Packages::Launcher2::R::drawable::cling, (IDrawable**)&mPunchThroughGraphic);
        r->GetDimensionPixelSize(Elastos::Droid::Packages::Launcher2::R::dimen::clingPunchThroughGraphicCenterRadius,
                &mPunchThroughGraphicCenterRadius);
        r->GetDimensionPixelSize(Elastos::Droid::Packages::Launcher2::R::dimen::app_icon_size,
                &mAppIconSize);

        Int32 size;
        r->GetDimensionPixelSize(Elastos::Droid::Packages::Launcher2::R::dimen::reveal_radius, &size);
        mRevealRadius = size * 1f;
        r->GetDimensionPixelSize(Elastos::Droid::Packages::Launcher2::R::dimen::button_bar_height, &mButtonBarHeight);
    ...
    if (mIsInitialized) {
        ...
        if (mBackground == NULL) {
            ...
            if (tmp1 || tmp2 || tmp3) {
                ...
                resources->GetDrawable(Elastos::Droid::Packages::Launcher2::R::drawable::bg_cling1,
                ...
                if (tmp4 || tmp5 || tmp6) {
                    AutoPtr<IResources> resources;
                    GetResources((IResources**)&resources);
                    resources->GetDrawable(Elastos::Droid::Packages::Launcher2::R::drawable::bg_cling2,
                            (IDrawable**)&mBackground);
                }
                else {
                    Boolean tmp7, tmp8;
                    ...
                    if (tmp7 || tmp8) {
                        AutoPtr<IResources> resources;
                        GetResources((IResources**)&resources);
                        resources->GetDrawable(Elastos::Droid::Packages::Launcher2::R::drawable::bg_cling3,
                                (IDrawable**)&mBackground);
                    }
                    else {
                        Boolean tmp9;
                        ...
                        if (tmp9) {
                            AutoPtr<IResources> resources;
                            GetResources((IResources**)&resources);
                            resources->GetDrawable(Elastos::Droid::Packages::Launcher2::R::drawable::bg_cling4,
                                    (IDrawable**)&mBackground);
                        }
                        else {
                            Boolean tmp10;
        ...
        if (tmp1 || tmp2 || tmp3) {
            if (mHandTouchGraphic == NULL) {
                AutoPtr<IResources> resources;
                GetResources((IResources**)&resources);
                resources->GetDrawable(Elastos::Droid::Packages::Launcher2::R::drawable::hand,
