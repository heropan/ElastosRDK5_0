...
#include "elastos/droid/packages/launcher2/UserInitializeReceiver.h"
    ...
    /* [in] */ IIntent* intent)
{
    ...
    AddWallpapers(resources, packageName, Elastos::Droid::Packages::Launcher2::R::array::wallpapers, list);
    AddWallpapers(resources, packageName, Elastos::Droid::Packages::Launcher2::R::array::extra_wallpapers, list);
