    ...
    /* [in] */ IAnimator* animation)
{
    ...
    String str;
    context->GetString(
            Elastos::Droid::Packages::Launcher2::R::string::folder_opened, &str);
    Int32 x;
    ...
    /* [in] */ IAnimator* animation)
{
    ...
    String str;
    context->GetString(
            Elastos::Droid::Packages::Launcher2::R::string::folder_closed, &str);
...
ECode Folder::MyRunnable::Run()
{
    ...
    if (count == 1) {
        ...
        mHost->mLauncher->CreateShortcut(
                Elastos::Droid::Packages::Launcher2::R::layout::application, cellLayout,
    ...
    /* [in] */ IAttributeSet* attrs)
{
    ...
    res->GetInteger(
            Elastos::Droid::Packages::Launcher2::R::integer::folder_max_count_x,
            &mMaxCountX);
    res->GetInteger(
            Elastos::Droid::Packages::Launcher2::R::integer::folder_max_count_y,
            &mMaxCountY);
    res->GetInteger(
            Elastos::Droid::Packages::Launcher2::R::integer::folder_max_num_items,
            &mMaxNumItems);
    ...
    res->GetInteger(
            Elastos::Droid::Packages::Launcher2::R::integer::config_folderAnimDuration,
            &mExpandDuration);

    if (sDefaultFolderName == NULL) {
        sDefaultFolderName = res->GetString(
                Elastos::Droid::Packages::Launcher2::R::string::folder_name);
    }
    if (sHintText == NULL) {
        sHintText = res->GetString(
                Elastos::Droid::Packages::Launcher2::R::string::folder_hint_text);
    }
...
ECode Folder::OnFinishInflate()
{
    ...
    AutoPtr<IView> view;
    FindViewById(
            Elastos::Droid::Packages::Launcher2::R::id::folder_content,
            (IView**)&view);
    ...
    AutoPtr<IView> view2;
    FindViewById(
            Elastos::Droid::Packages::Launcher2::R::id::folder_name
            (IView**)&view2);
    ...
    /* [in] */ Boolean commit)
{
    ...
    if (commit) {
        ...
        String str;
        context->GetString(
            Elastos::Droid::Packages::Launcher2::R::string::folder_renamed,
            &str);
    ...
    /* [out] */ IFolder** folder)
{
    ...
    AutoPtr<IView> view;
    inflater->Inflate(Elastos::Droid::Packages::Launcher2::R::layout::user_folder,
            NULL, (IView**)&view);
    ...
    /* [out] */ Boolean* result)
{
    ...
    AutoPtr<IView> view;
    mInflater->Inflate(
            Elastos::Droid::Packages::Launcher2::R::layout::application, this, FALSE,
            (IView**)&view);
...
void Folder::CenterAboutIcon()
{
    ...
    mLauncher->FindViewById(
            Elastos::Droid::Packages::Launcher2::R::id::drag_layer,
            (IView**)&view);
