...
#include "elastos/droid/packages/launcher2/CWallpaperChooser.h"
...
ECode CWallpaperChooser::OnCreate()
{
    ...
    SetContentView(Elastos::Droid::Packages::Launcher2::R::layout::wallpaper_chooser_base);

    AutoPtr<IFragmentManager> fmanager;
    GetFragmentManager((IFragmentManager**)&fmanager);
    AutoPtr<IFragment> fragmentView;
    fmanager->FindFragmentById(Elastos::Droid::Packages::Launcher2::R::id::wallpaper_chooser_fragment,
