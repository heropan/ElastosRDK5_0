...
#include "elastos/droid/packages/launcher2/AppsCustomizeTabHost.h"
...
ECode AppsCustomizeTabHost::OnFinishInflate()
{
    ...
    AutoPtr<IView> view;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::tabs_container,
            (IView**)&view);
    ...
    AutoPtr<IView> view2;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::apps_customize_pane_content,
            (IView**)&view2);
    ...
    mAppsCustomizePane = appsCustomizePane;
    AutoPtr<IView> view3;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::animation_buffer,
            (IView**)&view3);
    mAnimationBuffer = IFrameLayout::Probe(view3);

    AutoPtr<IView> view4;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::apps_customize_content,
            (IView**)&view4);
    ...
    IContext->GetString(Elastos::Droid::Packages::Launcher2::R::
            string::all_apps_button_label, &label);
    AutoPtr<IView> view2;
    mLayoutInflater->Inflate(Elastos::Droid::Packages::Launcher2::R::
    ...
    context2->getString(Elastos::Droid::Packages::Launcher2::R::
    ...
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::market_button,
            (IView**)&shopButton);
    ...
    /* [in] */ const String& tabId)
{
    ...
    Int32 duration;
    res->GetInteger(Elastos::Droid::Packages::Launcher2::R::
