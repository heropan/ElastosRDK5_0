...
#include "elastos/droid/packages/launcher2/HandleView.h"
    ...
    /* [in] */ Int32 defStyle)
{
    ...
    context->ObtainStyledAttributes(attrs,
            Elastos::Droid::Packages::Launcher2::R::styleable::HandleView, defStyle, 0, (ITypedArray**)&a);
    a->GetInt32(Elastos::Droid::Packages::Launcher2::R::styleable::HandleView_direction,
            ORIENTATION_HORIZONTAL, &mOrientation);
    a->Recycle();

    String str;
    context->GetString(Elastos::Droid::Packages::Launcher2::R::string::all_apps_button_label, &str)
