...
ECode DeleteDropTarget::OnFinishInflate()
{
    ...
    r->GetColor(Elastos::Droid::Packages::Launcher2::R::color::delete_target_hover_tint,
            &mHoverColor);
    AutoPtr<IDrawable> drawable;
    r->GetDrawable(Elastos::Droid::Packages::Launcher2::R::drawable::uninstall_target_selector,
            (IDrawable**)&drawable);
    mUninstallDrawable = ITransitionDrawable::Probe(drawable);

    AutoPtr<IDrawable> drawable2;
    r->GetDrawable(Elastos::Droid::Packages::Launcher2::R::drawable::remove_target_selector);
    ...
    /* [in] */ Int32 dragAction)
{
    ...
    if (length > 0) {
        SetText(isUninstall ?
                Elastos::Droid::Packages::Launcher2::R::string::delete_target_uninstall_label
                : Elastos::Droid::Packages::Launcher2::R::string::delete_target_label);
    }
    return NOERROR;
}
