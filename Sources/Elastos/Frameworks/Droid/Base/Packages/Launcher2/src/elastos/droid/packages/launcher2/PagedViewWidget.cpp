...
#include "elastos/droid/packages/launcher2/PagedViewWidget.h"
    ...
    /* [in] */ Int32* defStyle)
{
    ...
    r->GetString(Elastos::Droid::Packages::Launcher2::R::string::widget_dims_format, &mDimensionsFormatString);
...
ECode PagedViewWidget::OnFinishInflate()
{
    ...
    AutoPtr<IView> view;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::widget_preview, (IView**)&view);
    ...
    /* [in] */ IWidgetPreviewLoader* loader)
{
    ...
    AutoPtr<IView> view2;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::widget_name, (IView**)&view2);
    ...
    AutoPtr<IView> view3;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::widget_dims, (IView**)&view3);
    ...
    /* [in] */ IWidgetPreviewLoader* loader)
{
    ...
    AutoPtr<IView> view;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::widget_name, (IView**)&view);
    AutoPtr<ITextView> name = ITextView::Probe(view);
    name->SetText(label);

    AutoPtr<IView> view2;
    FindViewById(Elastos::Droid::Packages::Launcher2::R::id::widget_dims, (IView**)&view2);
