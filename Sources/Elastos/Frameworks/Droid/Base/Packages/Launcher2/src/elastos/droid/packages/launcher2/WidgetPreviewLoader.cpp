...
#include "elastos/droid/packages/launcher2/WidgetPreviewLoader.h"
    ...
    : sWidgetPreviewIconPaddingPercentage(0.25f)
{
    ...
    resources->GetDimensionPixelSize(
            Elastos::Droid::Packages::Launcher2::R::dimen::app_icon_size, &mAppIconSize);
    resources->GgetDimensionPixelSize(
            Elastos::Droid::Packages::Launcher2::R::dimen::profile_badge_size, &mProfileBadgeSize);
    resources->GetDimensionPixelSize(
            Elastos::Droid::Packages::Launcher2::R::dimen::profile_badge_margin, &mProfileBadgeMargin);
    ...
    /* [out] */ IBitmap** bitmap)
{
    ...
    *bitmap = NULL;
    ...
    if (widgetPreviewExists) {
        ...
        resources->GetDrawable(Elastos::Droid::Packages::Launcher2
    ...
    /* [out] */ IBitmap** bitmap)
{
    ...
    *bitmap = NULL;
    ...
    mContext->GetResources((IResources**)&resources);
    Int32 paddingTop;
    resources->GetDimensionPixelOffset(Elastos::Droid::Packages::Launcher2
