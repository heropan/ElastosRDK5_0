...
#include "elastos/droid/packages/launcher2/ButtonDropTarget.h"
    ...
    , TextView(context, attrs, defStyle)
{
    ...
    r->GetInteger(Elastos::Droid::Packages::Launcher2::R::integer::
            config_dropTargetBgTransitionDuration, &mTransitionDuration);
    r->GetDimensionPixelSize(Elastos::Droid::Packages::Launcher2::R::dimen::
