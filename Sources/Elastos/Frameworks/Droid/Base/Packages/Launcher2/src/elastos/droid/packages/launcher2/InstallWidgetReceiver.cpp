...
#include "elastos/droid/packages/launcher2/InstallWidgetReceiver.h"
    ...
    /* [out] */ IView** view)
{
    ...
    *view = NULL;
    ...
    if (convertView == NULL) {
        mInflater->Inflate(Elastos::Droid::Packages::Launcher2::R::layout::external_widget_drop_list_item, parent,
    ...
    AutoPtr<IView> _view;
    convertView->FindViewById(Elastos::Droid::Packages::Launcher2::R::id::provider_icon, (IView**)&_view);
    ...
    convertView->FindViewById(Elastos::Droid::Packages::Launcher2::R::id::provider, (IView**)&_view2);
    AutoPtr<ITextView> t = ITextView::Probe(_view2);
    String format;
    context->GetString(Elastos::Droid::Packages::Launcher2::R::string::external_drop_widget_pick_format,
