...
#include "elastos/droid/packages/launcher2/DrawableStateProxyView.h"
    ...
    /* [in] */ Int32 defStyle)
{
    ...
    context->ObtainStyledAttributes(attrs,
            Elastos::Droid::Packages::Launcher2::R::styleable::DrawableStateProxyView,
            defStyle, 0, (ITypedArray**)&a);
    a->GetResourceId(
            Elastos::Droid::Packages::Launcher2::R::styleable::DrawableStateProxyView_sourceViewId,
            -1, &mViewId);
    a->Recycle();
