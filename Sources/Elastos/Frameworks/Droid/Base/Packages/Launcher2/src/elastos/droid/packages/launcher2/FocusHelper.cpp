...
#include "elastos/droid/packages/launcher2/FocusHelper.h"
    ...
    /* [in] */ IKeyEvent* e)
{
    ...
    tabHost->FindViewById(
            Elastos::Droid::Packages::Launcher2::R::id::market_button, (IView**)&shop);
    ...
    /* [in] */ Int32 orientation)
{
    ...
    launcher->FindViewById(
            Elastos::Droid::Packages::Launcher2::R::id::workspace,
            (IView**)&view);
    ...
    /* [in] */ IKeyEvent* e)
{
    ...
    AutoPtr<IView> view;
    launcher->FindViewById(
            Elastos::Droid::Packages::Launcher2::R::id::qsb_bar, (IView**)&view);
    AutoPtr<IViewGroup> tabs = IViewGroup::Probe(view);

    AutoPtr<IView> view2;
    launcher->FindViewById(
            Elastos::Droid::Packages::Launcher2::R::id::hotseat, (IView**)&view2);
