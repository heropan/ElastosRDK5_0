...
#include "elastos/droid/packages/launcher2/AppWidgetResizeFrame.h"
    ...
    : FrameLayout(context)
{
    ...
    AutoPtr<IView> view;
    dragLayer->FindViewById(Elastos::Droid::Packages::Launcher2::R::id::workspace,
            (IView**)&view);
    ...
    SetBackgroundResource(Elastos::Droid::Packages::Launcher2::R
            ::drawable::widget_resize_frame_holo);
    SetPadding(0, 0, 0, 0);

    AutoPtr<IFrameLayoutLayoutParams> lp;
    CImageView::New(context, (IImageView**)&mLeftHandle);
    mLeftHandle->SetImageResource(Elastos::Droid::Packages::Launcher2::R
    ...
    mRightHandle->SetImageResource(Elastos::Droid::Packages::Launcher2::R
    ...
    mTopHandle->SetImageResource(Elastos::Droid::Packages::Launcher2::R
    ...
    mBottomHandle->SetImageResource(Elastos::Droid::Packages::Launcher2::R
