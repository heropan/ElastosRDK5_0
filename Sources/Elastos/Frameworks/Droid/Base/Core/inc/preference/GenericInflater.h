...
class GenericInflater : public ElRefBase
{
private:
    class FactoryMerger
        : public ElRefBase
...
public:
     ...
     * the given Context.
     */
    virtual CARAPI_(AutoPtr<GenericInflater>) CloneInContext(
        /* [in] */ IContext* newContext) = 0;
     ...
     */
    virtual CARAPI_(void) SetDefaultPackage(
     ...
     */
    virtual CARAPI_(String) GetDefaultPackage();
     ...
     */
    virtual CARAPI_(AutoPtr<IGenericInflaterFactory>) GetFactory();
