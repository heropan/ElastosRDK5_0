...
#ifndef __CPHONENUMBERFORMATTINGTEXTWATCHER_H__
#define __CPHONENUMBERFORMATTINGTEXTWATCHER_H__

#include "_CPhoneNumberFormattingTextWatcher.h"
...
#endif // __CPHONENUMBERFORMATTINGTEXTWATCHER_H__
