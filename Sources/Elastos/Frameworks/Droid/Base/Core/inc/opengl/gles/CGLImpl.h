...
public:
    ...
    CARAPI GlVertexPointer(
        ...
        /* [in] */ Int32 offset);
private:
    static CARAPI_(Boolean) AllowIndirectBuffers();
...
private:
    ...
    AutoPtr<IBuffer> m_PointSizePointerOES;
    AutoPtr<IBuffer> m_MatrixIndexPointerOES;
    AutoPtr<IBuffer> m_WeightPointerOES;

    Boolean mHaveCheckedExtensions;
    Boolean mHave_OES_blend_equation_separate;
    Boolean mHave_OES_blend_subtract;
    Boolean mHave_OES_framebuffer_object;
    Boolean mHave_OES_texture_cube_map;

    static const Int32 HAVE_OES_FRAMEBUFFER_OBJECTID = 0;
    static const Int32 HAVE_OES_BLEND_SUBTRACTID =1 ;
    static const Int32 HAVE_OES_BLEND_EQUATION_SEPARATEID = 2;
    static const Int32 HAVE_OES_TEXTURE_CUBE_MAPID = 3;
};
