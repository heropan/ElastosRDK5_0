...
#ifndef __CALERTCONTROLLERALERTPARAMS_H__
#define __CALERTCONTROLLERALERTPARAMS_H__

#include "_CAlertControllerAlertParams.h"
...
#endif //__CALERTCONTROLLERALERTPARAMS_H__
