...
#ifndef __CACTIVITYMANAGERMEMORYINFO_H__
#define __CACTIVITYMANAGERMEMORYINFO_H__

#include "_CActivityManagerMemoryInfo.h"
...
#endif //__CACTIVITYMANAGERMEMORYINFO_H__
