...
#ifndef __CACTIVITYMANAGERPRUNNINGAPPPROCESSINFO_H__
#define __CACTIVITYMANAGERPRUNNINGAPPPROCESSINFO_H__

#include "_CActivityManagerRunningAppProcessInfo.h"
...
#endif //__CACTIVITYMANAGERPRUNNINGAPPPROCESSINFO_H__
