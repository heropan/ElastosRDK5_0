...
#ifndef __CAPPLICATIONERRORREPORTBATTERYINFO_H__
#define __CAPPLICATIONERRORREPORTBATTERYINFO_H__

#include "_CApplicationErrorReportBatteryInfo.h"
...
#endif //__CAPPLICATIONERRORREPORTBATTERYINFO_H__
