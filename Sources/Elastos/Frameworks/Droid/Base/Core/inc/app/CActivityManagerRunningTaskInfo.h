...
#ifndef __CACTIVITYMANAGERRUNNINGTASKINFO_H__
#define __CACTIVITYMANAGERRUNNINGTASKINFO_H__

#include "_CActivityManagerRunningTaskInfo.h"
...
#endif //__CACTIVITYMANAGERRUNNINGTASKINFO_H__
