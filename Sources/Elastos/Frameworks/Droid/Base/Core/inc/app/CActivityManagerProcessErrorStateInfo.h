...
#ifndef __CACTIVITYMANAGERPROCESSERRORSTATEINFO_H__
#define __CACTIVITYMANAGERPROCESSERRORSTATEINFO_H__

#include "_CActivityManagerProcessErrorStateInfo.h"
...
#endif //__CACTIVITYMANAGERPROCESSERRORSTATEINFO_H__
