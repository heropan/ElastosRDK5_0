...
#ifndef __MEDIAROUTEINFO_H__
#define __MEDIAROUTEINFO_H__
...
public:
    ...
    AutoPtr<IRouteGroup> mGroup;

    AutoPtr<IRouteCategory> mCategory;
    ...
    AutoPtr<CMediaRouter::VolumeCallbackInfo> mVcb;
    ...
    AutoPtr<IIRemoteVolumeObserver> mRemoteVolObserver; // = new MyRemoteVolumeObserver();
