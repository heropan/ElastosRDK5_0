...
#ifndef __CONTACTSCONTRACTCONTACTS_H__
#define __CONTACTSCONTRACTCONTACTS_H__
...
public:
     ...
     */
    static CARAPI OpenContactPhotoInputStreamEx(
        /* [in] */ IContentResolver* cr,
        /* [in] */ IUri* contactUri,
        /* [out] */ IInputStream** stream);
};
...
#endif //__CONTACTSCONTRACTCONTACTS_H__