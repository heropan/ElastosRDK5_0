...
#ifndef __CCALENDARCONTRACTCALENDARS_H__
#define __CCALENDARCONTRACTCALENDARS_H__

#include "_CCalendarContractCalendars.h"
...
#endif //__CCALENDARCONTRACTCALENDARS_H__