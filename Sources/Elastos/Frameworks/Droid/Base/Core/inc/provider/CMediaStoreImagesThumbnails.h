...
#ifndef __CMEDIASTOREIMAGESTHUMBNAILS_H__
#define __CMEDIASTOREIMAGESTHUMBNAILS_H__

#include "_CMediaStoreImagesThumbnails.h"
...
#endif //__CMEDIASTOREIMAGESTHUMBNAILS_H__
