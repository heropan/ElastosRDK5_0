...
#ifndef __CCALENDARCONTRACTATTENDEES_H__
#define __CCALENDARCONTRACTATTENDEES_H__

#include "_CCalendarContractAttendees.h"
...
#endif //__CCALENDARCONTRACTATTENDEES_H__