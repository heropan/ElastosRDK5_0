#ifndef __CACCESSIBILITYINTERACTIONCONNECTION_H__
#define __CACCESSIBILITYINTERACTIONCONNECTION_H__

#include "_CAccessibilityInteractionConnection.h"
...
#endif //__CACCESSIBILITYINTERACTIONCONNECTION_H__
