...
private:
     ...
     * components.
     */
    static const Int32 PRESSED_STATE_DURATION = 64;

    /**
     * Defines the default duration in milliseconds before a press turns into
     * a long press
     */
    static const Int32 DEFAULT_LONG_PRESS_TIMEOUT = 500;

    /**
     * Defines the time between successive key repeats in milliseconds.
     */
    static const Int32 KEY_REPEAT_DELAY = 50;
     ...
     */
    static const Int32 TAP_TIMEOUT = 180;
     ...
     */
    static const Int32 HOVER_TAP_TIMEOUT = 150;
     ...
     */
    static const Int32 HOVER_TAP_SLOP = 20;
     ...
     */
    static const Int32 TOUCH_SLOP = 8;

    /**
     * Distance the first touch can wander before we stop considering this event a double tap
     * (in dips)
     */
    static const Int32 DOUBLE_TAP_TOUCH_SLOP = TOUCH_SLOP;
     ...
     */
    static const Int32 MAXIMUM_FLING_VELOCITY = 8000;
     ...
     */
    //@Deprecated
    static const Int32 MAXIMUM_DRAWING_CACHE_SIZE = 480 * 800 * 4; // ARGB8888
     ...
     */
    static const Int32 OVERFLING_DISTANCE = 6;
...
public:
     ...
     */
    static CARAPI_(AutoPtr<CViewConfiguration>) Get(
        /* [in] */ IContext* context);
...
private:
    ...
    static HashMap<Int32, AutoPtr<CViewConfiguration> > sConfigurations;
};
