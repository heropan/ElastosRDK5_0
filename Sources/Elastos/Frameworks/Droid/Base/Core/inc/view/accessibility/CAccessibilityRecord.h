#ifndef __CACCESSIBILITYRECORD_H__
#define __CACCESSIBILITYRECORD_H__

#include "ext/frameworkdef.h"
#include "_CAccessibilityRecord.h"
...
CarClass(CAccessibilityRecord), public AccessibilityRecord
{
public:
...
#endif //__CACCESSIBILITYRECORD_H__
