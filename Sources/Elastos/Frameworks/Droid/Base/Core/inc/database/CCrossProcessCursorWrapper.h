#ifndef __CCROSSPROCESSCURSORWRAPPER_H__
#define __CCROSSPROCESSCURSORWRAPPER_H__

#include "_CCrossProcessCursorWrapper.h"
...
#endif //__CCROSSPROCESSCURSORWRAPPER_H__