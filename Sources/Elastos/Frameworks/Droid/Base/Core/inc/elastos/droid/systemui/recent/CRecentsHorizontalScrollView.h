#ifndef __ELASTOS_DROID_SYSTEMUI_RECENT_CRECENTSHORIZONTALSCROLLVIEW_H__
...
CarClass(CRecentsHorizontalScrollView), public RecentsHorizontalScrollView
{
public:
    IVIEW_METHODS_DECL()
...
#endif //__ELASTOS_DROID_SYSTEMUI_RECENT_CRECENTSHORIZONTALSCROLLVIEW_H__
