...
#ifndef __ELASTOS_DROID_NET_INTERNAL_HTTP_MULTIPART_FILEPART_H__
#define __ELASTOS_DROID_NET_INTERNAL_HTTP_MULTIPART_FILEPART_H__
...
#endif // __ELASTOS_DROID_NET_INTERNAL_HTTP_MULTIPART_FILEPART_H__
