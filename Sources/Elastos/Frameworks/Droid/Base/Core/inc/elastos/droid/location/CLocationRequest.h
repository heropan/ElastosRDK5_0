...
private:
    static CARAPI_(void) CheckInterval(
        /* [in] */ Int64 millis);

    static CARAPI_(void) CheckQuality(
        /* [in] */ Int32 quality);

    static CARAPI_(void) CheckDisplacement(
        /* [in] */ Float meters);

    static CARAPI_(void) CheckProvider(
...
private:
     ...
     */
    static const Double FASTEST_INTERVAL_FACTOR;// = 6.0;  // 6x
