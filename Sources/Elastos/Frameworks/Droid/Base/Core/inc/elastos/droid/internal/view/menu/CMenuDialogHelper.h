#ifndef __ELASTOS_DROID_INTERNAL_VIEW_MENU_CMENUDIALOGHELPER_H__
#define __ELASTOS_DROID_INTERNAL_VIEW_MENU_CMENUDIALOGHELPER_H__

#include "_Elastos_Droid_Internal_View_Menu_CMenuDialogHelper.h"
