...
#ifndef __ELASTOS_DROID_INTERNAL_UTILITY_CASYNCCHANNEL_H__
#define __ELASTOS_DROID_INTERNAL_UTILITY_CASYNCCHANNEL_H__

#include "_Elastos_Droid_Internal_Utility_CAsyncChannel.h"
...
#endif //__ELASTOS_DROID_INTERNAL_UTILITY_CASYNCCHANNEL_H__
