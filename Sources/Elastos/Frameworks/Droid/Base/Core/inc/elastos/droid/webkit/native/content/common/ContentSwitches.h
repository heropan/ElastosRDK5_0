...
#ifndef __ELASTOS_DROID_WEBKIT_CONTENT_COMMON_CONTENTSWITCHES_H__
#define __ELASTOS_DROID_WEBKIT_CONTENT_COMMON_CONTENTSWITCHES_H__
...
#endif//__ELASTOS_DROID_WEBKIT_CONTENT_COMMON_CONTENTSWITCHES_H__
