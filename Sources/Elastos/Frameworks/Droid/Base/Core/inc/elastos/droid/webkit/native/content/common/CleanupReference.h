...
#ifndef __ELASTOS_DROID_WEBKIT_CONTENT_COMMON_CLEANUPREFERENCE_H__
#define __ELASTOS_DROID_WEBKIT_CONTENT_COMMON_CLEANUPREFERENCE_H__
...
#endif//__ELASTOS_DROID_WEBKIT_CONTENT_COMMON_CLEANUPREFERENCE_H__
