...
#ifndef __ELASTOS_DROID_WEBKIT_CONTENT_PUBLIC_BROWSER_NAVIGATIONCONTROLLER_H__
#define __ELASTOS_DROID_WEBKIT_CONTENT_PUBLIC_BROWSER_NAVIGATIONCONTROLLER_H__
...
#endif//__ELASTOS_DROID_WEBKIT_CONTENT_PUBLIC_BROWSER_NAVIGATIONCONTROLLER_H__
