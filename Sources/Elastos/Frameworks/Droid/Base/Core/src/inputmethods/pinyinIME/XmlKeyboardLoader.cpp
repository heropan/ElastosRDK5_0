...
String XmlKeyboardLoader::XMLTAG_SKB_TEMPLATE = String("skb_template");
String XmlKeyboardLoader::XMLTAG_KEYTYPE = String("key_type");
String XmlKeyboardLoader::XMLTAG_KEYICON = String("key_icon");
String XmlKeyboardLoader::XMLATTR_KEY_XMARGIN = String("key_xmargin");
String XmlKeyboardLoader::XMLATTR_KEY_YMARGIN = String("key_ymargin");
String XmlKeyboardLoader::XMLATTR_SKB_BG = String("skb_bg");
String XmlKeyboardLoader::XMLATTR_BALLOON_BG = String("balloon_bg");
String XmlKeyboardLoader::XMLATTR_POPUP_BG = String("popup_bg");
String XmlKeyboardLoader::XMLATTR_COLOR = String("color");
String XmlKeyboardLoader::XMLATTR_COLOR_HIGHLIGHT = String("color_highlight");
String XmlKeyboardLoader::XMLATTR_COLOR_BALLOON = String("color_balloon");
String XmlKeyboardLoader::XMLATTR_ID = String("id");
String XmlKeyboardLoader::XMLATTR_KEYTYPE_BG = String("bg");
String XmlKeyboardLoader::XMLATTR_KEYTYPE_HLBG = String("hlbg");
String XmlKeyboardLoader::XMLATTR_START_POS_X = String("start_pos_x");
String XmlKeyboardLoader::XMLATTR_START_POS_Y = String("start_pos_y");
String XmlKeyboardLoader::XMLATTR_ROW_ID = String("row_id");
String XmlKeyboardLoader::XMLTAG_KEYBOARD = String("keyboard");
String XmlKeyboardLoader::XMLTAG_ROW = String("row");
String XmlKeyboardLoader::XMLTAG_KEYS = String("keys");
String XmlKeyboardLoader::XMLTAG_KEY = String("key");
String XmlKeyboardLoader::XMLTAG_TOGGLE_STATE = String("toggle_state");
String XmlKeyboardLoader::XMLATTR_TOGGLE_STATE_ID = String("state_id");
String XmlKeyboardLoader::XMLATTR_SKB_TEMPLATE = String("skb_template");
String XmlKeyboardLoader::XMLATTR_SKB_CACHE_FLAG = String("skb_cache_flag");
String XmlKeyboardLoader::XMLATTR_SKB_STICKY_FLAG = String("skb_sticky_flag");
String XmlKeyboardLoader::XMLATTR_QWERTY = String("qwerty");
String XmlKeyboardLoader::XMLATTR_QWERTY_UPPERCASE = String("qwerty_uppercase");
String XmlKeyboardLoader::XMLATTR_KEY_TYPE = String("key_type");
String XmlKeyboardLoader::XMLATTR_KEY_WIDTH = String("width");
String XmlKeyboardLoader::XMLATTR_KEY_HEIGHT = String("height");
String XmlKeyboardLoader::XMLATTR_KEY_REPEAT = String("repeat");
String XmlKeyboardLoader::XMLATTR_KEY_BALLOON = String("balloon");
String XmlKeyboardLoader::XMLATTR_KEY_SPLITTER = String("splitter");
String XmlKeyboardLoader::XMLATTR_KEY_LABELS = String("labels");
String XmlKeyboardLoader::XMLATTR_KEY_CODES = String("codes");
String XmlKeyboardLoader::XMLATTR_KEY_LABEL = String("label");
String XmlKeyboardLoader::XMLATTR_KEY_CODE = String("code");
String XmlKeyboardLoader::XMLATTR_KEY_ICON = String("icon");
String XmlKeyboardLoader::XMLATTR_KEY_ICON_POPUP = String("icon_popup");
String XmlKeyboardLoader::XMLATTR_KEY_POPUP_SKBID = String("popup_skb");
