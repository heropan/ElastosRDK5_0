...
// CChangeText::
//===============================================================
//String CChangeText::LOG_TAG = "TextChange";

String CChangeText::PROPNAME_TEXT = String("android:textchange:text");
String CChangeText::PROPNAME_TEXT_SELECTION_START = String("android:textchange:textSelectionStart");
String CChangeText::PROPNAME_TEXT_SELECTION_END = String("android:textchange:textSelectionEnd");
String CChangeText::PROPNAME_TEXT_COLOR = String("android:textchange:textColor");
