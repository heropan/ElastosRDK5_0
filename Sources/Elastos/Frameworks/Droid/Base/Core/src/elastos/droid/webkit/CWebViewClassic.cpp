...
#include "elastos/droid/webkit/GeolocationPermissionsClassic.h"
 ...
 * Note this returns WebSettingsClassic, a sub-#include "elastos/droid/webkit/of WebSettings, which can be used
