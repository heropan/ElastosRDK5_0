...
AutoPtr< ArrayOf<Float> > BakedBezierInterpolator::MiddleInitTransformValues()
{
    // ==================before translated======================
...
AutoPtr< ArrayOf<Float> > BakedBezierInterpolator::MiddleInitFadeOutValues()
{
    // ==================before translated======================
    // float[] result = new float[] {
...
AutoPtr< ArrayOf<Float> > BakedBezierInterpolator::MiddleInitFadeInValues()
{
    // ==================before translated======================
    // float[] result = new float[] {
...
AutoPtr< ArrayOf<Float> > BakedBezierInterpolator::MiddleInitTransformFollowThroughValues()
{
    // ==================before translated======================
    // float[] result = new float[] {
