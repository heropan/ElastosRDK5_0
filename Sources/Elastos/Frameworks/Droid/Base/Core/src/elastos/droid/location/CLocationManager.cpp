...
{
    return LocationManager::Init(context, service);
}
    ...
    /* [out] */ IObjectContainer** allProvders)
{
    ...
    return LocationManager::GetAllProviders(allProvders);
}
...
ECode CLocationManager::RequestSingleUpdate(
    ...
    /* [in] */ ILooper* looper)
{
    return LocationManager::RequestSingleUpdate(provider, listener, looper);
}
...
ECode CLocationManager::RequestSingleUpdate(
    ...
    /* [in] */ ILooper* looper)
{
    return LocationManager::RequestSingleUpdate(criteria, listener, looper);
}
...
ECode CLocationManager::RequestLocationUpdates(
    ...
    /* [in] */ ILooper* looper)
{
    return LocationManager::RequestLocationUpdates(request, listener, looper);
}
...
ECode CLocationManager::AddProximityAlert(
    ...
    /* [in] */ IPendingIntent* intent)
{
    return LocationManager::AddProximityAlert(latitude, longitude, radius,
                expiration, intent);
}
 ...
 * @hide
 */
ECode CLocationManager::AddGeofence(
    /* [in] */ ILocationRequest* request,
    /* [in] */ IGeofence* fence,
    /* [in] */ IPendingIntent* intent)
{
 ...
 * @hide
 */
ECode CLocationManager::RemoveGeofence(
    /* [in] */ IGeofence* fence,
    /* [in] */ IPendingIntent* intent)
{
 ...
 * @hide
 */
ECode CLocationManager::RemoveAllGeofences(
    /* [in] */ IPendingIntent* intent)
{
 ...
 * @hide
 */
ECode CLocationManager::GetLastLocation(
...
ECode CLocationManager::AddTestProvider(
    ...
    /* [in] */ Int32 accuracy)
{
    return LocationManager::AddTestProvider(name, requiresNetwork,
