...
const Int32 IconUtilities::sColors[];

IconUtilities::IconUtilities(
    /* [in] */ IContext* context)
    : 0xffffc300);
         mGlowColorPressedPaint.setMaskFilter(TableMaskFilter.CreateClipTable(0
    : 30));
    ...
    : true) ? value.data : 0xffff8e00);
         mGlowColorFocusedPaint.setMaskFilter(TableMaskFilter.CreateClipTable(0
    : 30));
...
ECode IconUtilities::CreateIconDrawable(
    /* [in] */ IDrawable* src,
    /* [out] */ Drawable** result)
{
