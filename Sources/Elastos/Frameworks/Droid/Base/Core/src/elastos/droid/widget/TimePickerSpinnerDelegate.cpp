...
//=====================================================================
//         TimePickerSpinnerDelegate::InnerViewOnClickListener1
//=====================================================================
TimePickerSpinnerDelegate::InnerViewOnClickListener1::InnerViewOnClickListener1(
...
ECode TimePickerSpinnerDelegate::InnerViewOnClickListener1::OnClick(
    /* [in] */ IView* v)
{
    VALIDATE_NOT_NULL(v);
    // ==================before translated======================
...
//=====================================================================
//         TimePickerSpinnerDelegate::InnerViewOnClickListener3
//=====================================================================
TimePickerSpinnerDelegate::InnerViewOnClickListener3::InnerViewOnClickListener3(
    /* [in] */ TimePickerSpinnerDelegate* owner)
    : mOwner(owner)
{
    // ==================before translated======================
...
ECode TimePickerSpinnerDelegate::InnerViewOnClickListener3::OnClick(
    /* [in] */ IView* v)
{
    VALIDATE_NOT_NULL(v);
    // ==================before translated======================
...
//=====================================================================
//         TimePickerSpinnerDelegate::InnerViewOnClickListener5
//=====================================================================
TimePickerSpinnerDelegate::InnerViewOnClickListener5::InnerViewOnClickListener5(
    /* [in] */ TimePickerSpinnerDelegate* owner)
    : mOwner(owner)
{
    // ==================before translated======================
...
ECode TimePickerSpinnerDelegate::InnerViewOnClickListener5::OnClick(
    /* [in] */ IView* v)
{
    VALIDATE_NOT_NULL(v);
    // ==================before translated======================
