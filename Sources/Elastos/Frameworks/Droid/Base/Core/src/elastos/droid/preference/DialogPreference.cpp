...
PInterface DialogPreference::Probe(
    /* [in] */REIID riid)
{
...
UInt32 DialogPreference::AddRef()
{
    return ElRefBase::AddRef();
}

UInt32 DialogPreference::Release()
{
    return ElRefBase::Release();
}

ECode DialogPreference::GetInterfaceID(
    ...
    /* [in] */ Int32 dialogIconRes)
{
    ...
    res->GetDrawable(dialogIconRes, (IDrawable**)&drawable);
