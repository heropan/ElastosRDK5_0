    ...
    /* [in] */ Boolean flow)
{
    ...
    if (isLayoutRtl) {
        Int32 width;
        GetWidth(&width);
        nextLeft = width - ((CRect*)mListPadding.Get())->mRight - columnWidth -
                ((mStretchMode == STRETCH_SPACING_UNIFORM) ? horizontalSpacing : 0);
    } else {
        nextLeft = ((CRect*)mListPadding.Get())->mLeft +
                ((mStretchMode == STRETCH_SPACING_UNIFORM) ? horizontalSpacing : 0);
    }
    ...
    /* [in] */ Int32 nextBottom)
{
    ...
    Int32 end = 0;
    if ((mGroupFlags & CLIP_TO_PADDING_MASK) == CLIP_TO_PADDING_MASK) {
        end = ((CRect*)mListPadding.Get())->mTop;
    }
    ...
    /* [in] */ Int32 childCount)
{
    if (mFirstPosition == 0 && childCount > 0) {
        ...
        Int32 start = ((CRect*)mListPadding.Get())->mTop;
    ...
    /* [in] */ Int32 heightMeasureSpec)
{
    ...
    if (widthMode == MeasureSpec::UNSPECIFIED) {
        if (mColumnWidth > 0) {
            widthSize = mColumnWidth + ((CRect*)mListPadding.Get())->mLeft + ((CRect*)mListPadding.Get())->mRight;
        } else {
            widthSize = ((CRect*)mListPadding.Get())->mLeft + ((CRect*)mListPadding.Get())->mRight;
        }
    ...
    Int32 childWidth = widthSize - ((CRect*)mListPadding.Get())->mLeft - ((CRect*)mListPadding.Get())->mRight;
    ...
    if (heightMode == MeasureSpec::UNSPECIFIED) {
        ...
        heightSize = ((CRect*)mListPadding.Get())->mTop + ((CRect*)mListPadding.Get())->mBottom + childHeight +
                verticalFadingEdgeLength * 2;
    }

    if (heightMode == MeasureSpec::AT_MOST) {
        Int32 ourSize =  ((CRect*)mListPadding.Get())->mTop + ((CRect*)mListPadding.Get())->mBottom;
...
//try {
    ...
    Int32 childrenTop = ((CRect*)mListPadding.Get())->mTop;
    Int32 childrenBottom = mBottom - mTop - ((CRect*)mListPadding.Get())->mBottom;
...
ECode GridView::AdjustViewsUpOrDown()
{
    ...
    if (childCount > 0) {
        ...
        if (!mStackFromBottom) {
            ...
            Int32 top = 0;
            child->GetTop(&top);
            delta = top - ((CRect*)mListPadding.Get())->mTop;
            if (mFirstPosition != 0) {
            ...
            child->GetBottom(&bottom);
            GetHeight(&height);
            delta = bottom - (height - ((CRect*)mListPadding.Get())->mBottom);
