...
class SkiaCanvas : public NativeCanvas {
public:
...
NativeCanvas* NativeCanvas::create_canvas(SkBitmap* bitmap) {
    return new SkiaCanvas(bitmap);
}

NativeCanvas* NativeCanvas::create_canvas(SkCanvas* skiaCanvas) {
