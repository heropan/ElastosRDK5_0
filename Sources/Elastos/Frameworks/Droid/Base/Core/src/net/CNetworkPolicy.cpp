    ...
    /* [out] */ String* result)
{
    ...
    builder += StringUtils::Int32ToString(mCycleDay);
    builder += String(", cycleTimezone=");
    builder += mCycleTimezone;
    builder += String(", warningBytes=");
    builder += StringUtils::Int64ToString(mWarningBytes);
    builder += String(", limitBytes=");
    builder += StringUtils::Int64ToString(mLimitBytes);
    builder += String(", lastWarningSnooze=");
    builder += StringUtils::Int64ToString(mLastWarningSnooze);
    builder += String(", lastLimitSnooze=");
    builder += StringUtils::Int64ToString(mLastLimitSnooze);
