    ...
    /* [out] */ String* result)
{
    ...
    builder += mIface;
    builder += String(" uid=");
    builder += StringUtils::Int32ToString(mUid);
    builder += String(" set=");
    builder += StringUtils::Int32ToString(mSet);
    builder += String(" tag=");
    builder += StringUtils::Int32ToString(mTag);
    builder += String(" rxBytes=");
    builder += StringUtils::Int64ToString(mRxBytes);
    builder += String(" rxPackets=");
    builder += StringUtils::Int64ToString(mRxPackets);
    builder += String(" txBytes=");
    builder += StringUtils::Int64ToString(mTxBytes);
    builder += String(" txPackets=");
    builder += StringUtils::Int64ToString(mTxPackets);
    builder += String(" operations=");
    builder += StringUtils::Int64ToString(mOperations);
