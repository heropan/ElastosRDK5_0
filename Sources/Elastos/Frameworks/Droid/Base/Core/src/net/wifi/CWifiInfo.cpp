    ...
    /* [out] */ String* str)
{
    ...
    sb.AppendString(mWifiSsid == NULL ? IWifiSsid::NONE : sidStr);
    sb.AppendCStr(", BSSID: ");
    sb.AppendString(mBSSID.IsNull() ? none : mBSSID);
    sb.AppendCStr(", MAC: ");
    sb.AppendString(mMacAddress.IsNull() ? none : mMacAddress);
    sb.AppendCStr(", Supplicant state: ");
    if (mSupplicantState == NULL) sb.AppendString(none);
    sb.AppendInt32(mSupplicantState);
    sb.AppendCStr(", RSSI: ");
    sb.AppendInt32(mRssi);
    sb.AppendCStr(", Link speed: ");
    sb.AppendInt32(mLinkSpeed);
    sb.AppendCStr(", Net ID: ");
    sb.AppendInt32(mNetworkId);
    sb.AppendCStr(", Metered hint: ");
