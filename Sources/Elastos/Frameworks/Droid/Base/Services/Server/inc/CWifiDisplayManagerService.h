#ifndef __CWIFIDISPLAYMANAGERSERVICE_H__
#define __CWIFIDISPLAYMANAGERSERVICE_H__

#include "ext/frameworkext.h"
#include "_CWifiDisplayManagerService.h"
...
#endif //__CWIFIDISPLAYMANAGERSERVICE_H__
