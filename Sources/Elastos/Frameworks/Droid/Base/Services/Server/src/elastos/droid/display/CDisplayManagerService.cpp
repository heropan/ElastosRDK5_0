...
#include "display/HeadlessDisplayAdapter.h"
...
CDisplayManagerService::DisplayManagerHandler::DisplayManagerHandler(
    ...
    : HandlerBase(looper, NULL, TRUE /*async*/)
    , mHost(host)
{
}
...
//==============================================================================
CAR_INTERFACE_IMPL(CDisplayManagerService::DisplayAdapterListener, IDisplayAdapterListener)
