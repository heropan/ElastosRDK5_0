    ...
    /* [out] */ Boolean *result)
{
    ...
    *result = FALSE;
    ...
    HMIterator it = mMimeTypeToExtensionMap->Find(mimeType);
    *result = (it != mMimeTypeToExtensionMap->End());
    return NOERROR;
}
    ...
    /* [out] */ String* result)
{
    ...
    *result = (*mExtensionToMimeTypeMap)[extension];
    return NOERROR;
}
    ...
    /* [out] */ Boolean* result)
{
    ...
    *result = FALSE;
    ...
    HMIterator it = mExtensionToMimeTypeMap->Find(extension);
    *result = (it == mExtensionToMimeTypeMap->End());
    return NOERROR;
}
    ...
    /* [out] */ String* result)
{
    ...
    *result = (*mMimeTypeToExtensionMap)[mimeType];
    return NOERROR;
}
...
void CMimeUtils::Add(
    ...
    /* [in] */ const String& extension)
{
    HMIterator find = mMimeTypeToExtensionMap->Find(mimeType);
...
ECode CMimeUtils::ApplyOverrides()
{
...
ECode CMimeUtils::GetContentTypesPropertiesStream(
