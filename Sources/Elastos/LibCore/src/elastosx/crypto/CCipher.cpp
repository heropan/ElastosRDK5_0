...
CAR_OBJECT_IMPL(CCipher)
CAR_INTERFACE_IMPL(CCipher, Object, ICipher)

const String CCipher::SERVICE = String("Cipher");

//TODO: Need IEngine
//AutoPtr<IEngine> CCipher::mENGINE;

const String CCipher::ATTRIBUTE_PADDINGS = String("SupportedPaddings");

const String CCipher::ATTRIBUTE_MODES = String("SupportedModes");

AutoPtr<ISecureRandom> CCipher::mSecureRandom;
...
ECode CCipher::GetExemptionMechanism(
...
// virtual Elastos::ECode Elastosx::Crypto::ICipher::Unwrap(
//     Elastos::ArrayOf<unsigned char>*,
//     const Elastos::String&,
//     Elastos::Int32,
//     Elastos::Security::IKey**)
ECode CCipher::Unwrap(
...
ECode CCipher::GetMaxAllowedKeyLength(
    /* [in] */ const String& transformation,
    /* [out] */ Int32 * value)
{
    VALIDATE_NOT_NULL(value);
...
ECode CCipher::GetMaxAllowedParameterSpec(
    /* [in] */ const String& transformation,
...
ECode CCipher::CheckTransformation(
    /* [in] */ const String& transformation,
...
//TODO: Need IEngine
// AutoPtr<Engine.SpiAndProvider> CCipher::TryCombinations(
//     /* [in] */ IKey* key,
//     /* [in] */ IProvider* provider,
//     /* [in] */ ArrayOf<String> * transformParts)
// {
...
// AutoPtr<Engine.SpiAndProvider> CCipher::TryTransform(
//     /* [in] */ IKey* key,
//     /* [in] */ IProvider* provider,
...
// AutoPtr<Engine.SpiAndProvider> CCipher::TryTransformWithProvider(
//     /* [in] */ IKey* key,
//     /* [in] */ ArrayOf<String> * transformParts,
//     /* [in] */ NeedToSet type,
...
Boolean CCipher::MatchAttribute(
    /* [in] */ IService* service,
...
ECode CCipher::CheckInputOffsetAndCount(
