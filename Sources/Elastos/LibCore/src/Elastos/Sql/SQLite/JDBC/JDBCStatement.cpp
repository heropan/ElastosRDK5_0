...
Boolean JDBCStatement::ExecuteEx(
    /* [in] */ const String& sql,
...
Boolean JDBCStatement::ExecuteEx2(
    /* [in] */ const String& sql,
...
Boolean JDBCStatement::ExecuteEx3(
    /* [in] */ const String& sql,
    ...
    /* [in] */ const String& sql)
{
    ...
    return ExecuteQueryEx(sql, *args, FALSE);
}

AutoPtr<IResultSet> JDBCStatement::ExecuteQueryEx(
    /* [in] */ const String& sql,
    ...
    while (TRUE) {
        // try {
            ...
            if (args.GetLength()) {
                ...
                if (updonly) {
                    ecreturn = ((CJDBCConnection *)&conn)->mDb->ExecEx(sql, NULL, args);
                    if (ecreturn != NOERROR)
                    {
                        flagreturn = TRUE;
                    }
                } else {
                    ecreturn = ((CJDBCConnection *)&conn)->mDb->GetTableEx2(sql, maxrows, args,(ITableResult **)&tr);
                    if (ecreturn != NOERROR)
                    {
                        flagreturn = TRUE;
                    }
...
{
    AutoPtr<ArrayOf<String> > args = NULL ;
    ExecuteQueryEx(sql, *args, TRUE);
    return updcnt;
}

Int32 JDBCStatement::ExecuteUpdateEx(
    /* [in] */ const String& sql,
    /* [in] */ Int32 autoGeneratedKeys)
{
    if (autoGeneratedKeys != Elastos::Sql::IStatement::NO_GENERATED_KEYS) {
...
Int32 JDBCStatement::ExecuteUpdateEx2(
    /* [in] */ const String& sql,
    /* [in] */ const ArrayOf<Int32>& columnIndexes)
{
    // throw new SQLFeatureNotSupportedException();
...
Int32 JDBCStatement::ExecuteUpdateEx3(
    /* [in] */ const String& sql,
    /* [in] */ const ArrayOf<String>& columnNames)
{
    // throw new SQLFeatureNotSupportedException();
...
Boolean JDBCStatement::GetMoreResultsEx(
    /* [in] */ Int32 current)
{
    if (rs != NULL) {
        ((CJDBCResultSet *)&rs)->Close();
