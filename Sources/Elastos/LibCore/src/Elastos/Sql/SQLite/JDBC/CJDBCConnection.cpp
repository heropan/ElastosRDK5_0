    ...
    /* [out] */ IStatement ** ppStatement)
{
    ...
    ECode ec = NOERROR;
    ec = CreateStatementEx(resultSetType, resultSetConcurrency,ppStatement);
    return ec;
}
...
ECode CJDBCConnection::PrepareCallEx2(
    /* [in] */ const String& sql,
    /* [in] */ Int32 resultSetType,
    /* [in] */ Int32 resultSetConcurrency,
    /* [in] */ Int32 resultSetHoldability,
    ...
    /* [out] */ Elastos::Sql::IPreparedStatement ** ppPreparedStatement)
{
    ...
    return PrepareStatementEx3(sql, resultSetType, resultSetConcurrency, ppPreparedStatement);;
}
...
ECode CJDBCConnection::RollbackEx(
    /* [in] */ Elastos::Sql::ISavePoint * pSavepoint)
{
    return E_SQL_FEATURE_NOT_SUPPORTED_EXCEPTION;
}
    ...
    /* [in] */ Boolean readOnly)
{
    ...
    if (readOnly != mReadonly) {
        AutoPtr<IDatabaseX> dbx;
        ec = Open(readOnly, (IDatabaseX**)&dbx);
        if (FAILED(ec)) {
            return E_SQL_EXCEPTION;
        }
        ec = mDb->Close();
...
ECode CJDBCConnection::GetClientInfoEx(
    ...
    /* [in] */ const String& vfs)
{
    ...
    ec = Open(mReadonly, (IDatabaseX**)&mDb);
    if (FAILED(ec)) {
        return E_SQL_EXCEPTION;
    }
    ...
    /* [out] */ IDatabaseX** db)
{
    ...
    ec = CDatabaseX::New((IDatabaseX**)&dbx);
#if HAVE_SQLITE3
    ec = dbx->OpenEx(mDbfile, readonly ? SQLITE_OPEN_READONLY :
        (SQLITE_OPEN_READWRITE | SQLITE_OPEN_CREATE), mVfs);
#else
    ec = dbx->OpenEx(mDbfile, readonly ? IConstants::SQLITE_OPEN_READONLY :
