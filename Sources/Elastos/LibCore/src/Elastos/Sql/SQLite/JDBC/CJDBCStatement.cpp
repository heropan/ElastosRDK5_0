...
ECode CJDBCStatement::ExecuteEx(
    /* [in] */ const String& sql,
    /* [in] */ Int32 autoGeneratedKeys,
    /* [out] */ Boolean* value)
{
    *value = JDBCStatement::ExecuteEx(sql,autoGeneratedKeys);
    return NOERROR;
}

ECode CJDBCStatement::ExecuteEx2(
    /* [in] */ const String& sql,
    /* [in] */ const ArrayOf<Int32>& columnIndexes,
    /* [out] */ Boolean* value)
{
    *value = JDBCStatement::ExecuteEx2(sql,columnIndexes);
    return NOERROR;
}

ECode CJDBCStatement::ExecuteEx3(
    /* [in] */ const String& sql,
    /* [in] */ const ArrayOf<String>& columnNames,
    /* [out] */ Boolean* value)
{
    *value = JDBCStatement::ExecuteEx3(sql,columnNames);
    return NOERROR;
}
...
ECode CJDBCStatement::ExecuteUpdateEx(
    /* [in] */ const String& sql,
    /* [in] */ Int32 autoGeneratedKeys,
    /* [out] */ Int32* value)
{
    *value = JDBCStatement::ExecuteUpdateEx(sql,autoGeneratedKeys);
    return NOERROR;
}

ECode CJDBCStatement::ExecuteUpdateEx2(
    /* [in] */ const String& sql,
    /* [in] */ const ArrayOf<Int32>& columnIndexes,
    /* [out] */ Int32* value)
{
    *value = JDBCStatement::ExecuteUpdateEx2(sql,columnIndexes);
    return NOERROR;
}

ECode CJDBCStatement::ExecuteUpdateEx3(
    /* [in] */ const String& sql,
    /* [in] */ const ArrayOf<String>& columnNames,
    /* [out] */ Int32* value)
{
    *value = JDBCStatement::ExecuteUpdateEx3(sql,columnNames);
    return NOERROR;
}
...
ECode CJDBCStatement::GetMoreResultsEx(
    /* [in] */ Int32 current,
    /* [out] */ Boolean* value)
{
    *value = JDBCStatement::GetMoreResultsEx(current);
    return NOERROR;
}
