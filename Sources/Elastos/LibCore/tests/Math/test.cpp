...
void testIntegralToString()
{
    ...
    printf(" 0x0: %s\n", (const char*)IntegralToString::Int32ToString(0x0));
    printf(" 0x1: %s\n", (const char*)IntegralToString::Int32ToString(0x1));
    printf(" 0x10: %s\n", (const char*)IntegralToString::Int32ToString(0x10));
    printf(" 0xFF: %s\n", (const char*)IntegralToString::Int32ToString(0xFF));
    printf(" 0xFFFFFFFF: %s\n", (const char*)IntegralToString::Int32ToString(0xFFFFFFFF));
    printf(" -1: %s\n", (const char*)IntegralToString::Int32ToString(-1));
    printf(" -2: %s\n", (const char*)IntegralToString::Int32ToString(-2));
    printf(" -0xFFFFFFFF: %s\n", (const char*)IntegralToString::Int32ToString(-0xFFFFFFFF));
    printf("INT32_MAX_VALUE %s\n", (const char*)IntegralToString::Int32ToString(i));
    printf("\n");

    printf(" =======Int32ToBinaryString========\n");
    printf(" 0x0: %s\n", (const char*)IntegralToString::Int32ToBinaryString(0x0));
    printf(" 0x1: %s\n", (const char*)IntegralToString::Int32ToBinaryString(0x1));
    printf(" 0x10: %s\n", (const char*)IntegralToString::Int32ToBinaryString(0x10));
    printf(" 0xFF: %s\n", (const char*)IntegralToString::Int32ToBinaryString(0xFF));
    printf(" 0xFFFFFFFF: %s\n", (const char*)IntegralToString::Int32ToBinaryString(0xFFFFFFFF));
    printf(" -1: %s\n", (const char*)IntegralToString::Int32ToBinaryString(-1));
    printf(" -2: %s\n", (const char*)IntegralToString::Int32ToBinaryString(-2));
    printf(" -0xFFFFFFFF: %s\n", (const char*)IntegralToString::Int32ToBinaryString(-0xFFFFFFFF));
    printf("INT32_MAX_VALUE %s\n", (const char*)IntegralToString::Int32ToBinaryString(i));
    printf("\n");

    printf(" =======Int32ToOctalString========\n");
    printf(" 0x0: %s\n", (const char*)IntegralToString::Int32ToOctalString(0x0));
    printf(" 0x1: %s\n", (const char*)IntegralToString::Int32ToOctalString(0x1));
    printf(" 0x10: %s\n", (const char*)IntegralToString::Int32ToOctalString(0x10));
    printf(" 0xFF: %s\n", (const char*)IntegralToString::Int32ToOctalString(0xFF));
    printf(" 0xFFFFFFFF: %s\n", (const char*)IntegralToString::Int32ToOctalString(0xFFFFFFFF));
    printf(" -1: %s\n", (const char*)IntegralToString::Int32ToOctalString(-1));
    printf(" -2: %s\n", (const char*)IntegralToString::Int32ToOctalString(-2));
    printf(" -0xFFFFFFFF: %s\n", (const char*)IntegralToString::Int32ToOctalString(-0xFFFFFFFF));
    printf("INT32_MAX_VALUE %s\n", (const char*)IntegralToString::Int32ToOctalString(i));
    printf("\n");

    printf(" =======Int32ToHexString========\n");
    printf(" 0x0: %s\n", (const char*)IntegralToString::Int32ToHexString(0x0));
    printf(" 0x1: %s\n", (const char*)IntegralToString::Int32ToHexString(0x1));
    printf(" 0x10: %s\n", (const char*)IntegralToString::Int32ToHexString(0x10));
    printf(" 0xFF: %s\n", (const char*)IntegralToString::Int32ToHexString(0xFF));
    printf(" 0xFFFFFFFF: %s\n", (const char*)IntegralToString::Int32ToHexString(0xFFFFFFFF));
    printf(" -1: %s\n", (const char*)IntegralToString::Int32ToHexString(-1));
    printf(" -2: %s\n", (const char*)IntegralToString::Int32ToHexString(-2));
    printf(" -0xFFFFFFFF: %s\n", (const char*)IntegralToString::Int32ToHexString(-0xFFFFFFFF));
    printf("INT32_MAX_VALUE %s\n", (const char*)IntegralToString::Int32ToHexString(i));
    printf("\n");
