...
CTest::CTest(){
    setUp();
    CStringWrapper::New(String("yoink"), (ICharSequence**)&youink);
    CStringWrapper::New(String("kazoo"), (ICharSequence**)&kazoo);
}
...
int CTest::test_clear(int argc, char* argv[])
{
    ...
    CStringWrapper::New(String("bam"), (ICharSequence**)&bam);
...
PFL
    ...
    CStringWrapper::New(String("e"), (ICharSequence**)&cse);
    AutoPtr<ICharSequence> csf;
    CStringWrapper::New(String("f"), (ICharSequence**)&csf);
    AutoPtr<ICharSequence> csg;
    CStringWrapper::New(String("g"), (ICharSequence**)&csg);
    list->Add(csa, &isflag);
    list->Add(csb, &isflag);
    list->Add(csc, &isflag);
    list->Add(csd, &isflag);
...
int CTest::test_addAll(int argc, char* argv[])
{
    ...
    CStringWrapper::New(String("1"), (ICharSequence**)&cs1);
    AutoPtr<ICharSequence> cs2;
    CStringWrapper::New(String("2"), (ICharSequence**)&cs2);
    AutoPtr<ICharSequence> cs3;
    CStringWrapper::New(String("3"), (ICharSequence**)&cs3);
    ...
    CStringWrapper::New(String("4"), (ICharSequence**)&cs4);
    AutoPtr<ICharSequence> cs5;
    CStringWrapper::New(String("5"), (ICharSequence**)&cs5);
    AutoPtr<ICharSequence> cs6;
    CStringWrapper::New(String("6"), (ICharSequence**)&cs6);
    AutoPtr<ICharSequence> cs7;
    CStringWrapper::New(String("7"), (ICharSequence**)&cs7);
    AutoPtr<ICharSequence> cs8;
    CStringWrapper::New(String("8"), (ICharSequence**)&cs8);
    AutoPtr<ICharSequence> cs9;
    CStringWrapper::New(String("9"), (ICharSequence**)&cs9);
    AutoPtr<ICharSequence> cs10;
    CStringWrapper::New(String("10"), (ICharSequence**)&cs10);
    AutoPtr<ICharSequence> cs11;
    CStringWrapper::New(String("11"), (ICharSequence**)&cs11);
    AutoPtr<ICharSequence> cs12;
    CStringWrapper::New(String("12"), (ICharSequence**)&cs12);
