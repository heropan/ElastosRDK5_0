...
#ifndef __CCDATASECTIONIMPL_H__
#define __CCDATASECTIONIMPL_H__
...
public:
    ...
    CARAPI NeedsSplitting(
        /* [out] */ Boolean * pNeedsSplitting);

    CARAPI ReplaceWithText(
