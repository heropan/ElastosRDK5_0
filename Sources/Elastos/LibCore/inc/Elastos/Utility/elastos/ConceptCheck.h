...
#define Concept_ClassRequires(a,C)                                  \
            _ELASTOS_CLASS_REQUIRES(a, Elastos::Utility, C);
#define Concept_ClassRequires2(a,b,C)                              \
            _ELASTOS_CLASS_REQUIRES2(a, b, Elastos::Utility, C);
#define Concept_ClassRequires3(a,b,c,C)                           \
            _ELASTOS_CLASS_REQUIRES3(a, b, c, Elastos::Utility, C);
#define Concept_ClassRequires4(a,b,c,d,C)                        \
            _ELASTOS_CLASS_REQUIRES4(a, b, c, d, Elastos::Utility, C);
