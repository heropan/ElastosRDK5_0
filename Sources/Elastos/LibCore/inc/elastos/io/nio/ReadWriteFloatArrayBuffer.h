#ifndef __ELASTOS_IO_READWRITEFLOATARRAYBUFFER_H__
#define __ELASTOS_IO_READWRITEFLOATARRAYBUFFER_H__
...
public:
    ...
    static CARAPI_(AutoPtr<ReadWriteFloatArrayBuffer>) Copy(
...
#endif // __ELASTOS_IO_READWRITEFLOATARRAYBUFFER_H__
