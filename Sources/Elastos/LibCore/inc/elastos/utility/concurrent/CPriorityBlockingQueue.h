...
#ifndef __ELASTOS_UTILITY_CPRIORITYBLOCKINGQUEUE_H__
#define __ELASTOS_UTILITY_CPRIORITYBLOCKINGQUEUE_H__
...
#endif //__ELASTOS_UTILITY_CPRIORITYBLOCKINGQUEUE_H__
