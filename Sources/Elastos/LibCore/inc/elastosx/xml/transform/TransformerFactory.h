...
#ifndef  __ELASTOSX_XML_TRANSFORM_TRANSFORMERFACTORY_H__
#define  __ELASTOSX_XML_TRANSFORM_TRANSFORMERFACTORY_H__
...
public:
    ...
    */
     ...
     */
    static CARAPI_(AutoPtr<ITransformerFactory>) NewInstance() /*throws TransformerFactoryConfigurationError*/;
    /**
     ...
     * @since 1.6
     */
    static CARAPI_(AutoPtr<ITransformerFactory>) NewInstance(
    ...
    virtual CARAPI NewTransformer(
        /* [in] */ ISource* source,
        /* [out] */ ITransformer** tf) = 0 /*throws TransformerConfigurationException*/;
    ...
    virtual CARAPI NewTemplates(
        /* [in] */ ISource* source,
        /* [out] */ ITemplates** t) = 0 /*throws TransformerConfigurationException*/;
    ...
    virtual CARAPI GetAssociatedStylesheet(
        /* [in] */ ISource* source,
        /* [in] */ const String& media,
        /* [in] */ const String& title,
        /* [in] */ const String& charset,
        /* [out] */ ISource** as) = 0 /*throws TransformerConfigurationException*/;
    ...
    virtual CARAPI SetFeature(
        ...
        /* [in] */ Boolean value) = 0 /*throws TransformerConfigurationException*/;
...
#endif  // __ELASTOSX_XML_TRANSFORM_TRANSFORMERFACTORY_H__
