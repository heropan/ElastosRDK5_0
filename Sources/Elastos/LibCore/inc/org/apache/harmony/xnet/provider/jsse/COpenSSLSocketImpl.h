...
#ifndef __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLSOCKETIMPL_H__
#define __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLSOCKETIMPL_H__

#include "_COpenSSLSocketImpl.h"
...
public:
    ...
    CARAPI ClientCertificateRequested(
        /* [in] */ ArrayOf<Byte> * pKeyTypes,
        /* [in] */ ArrayOf<Byte> * pAsn1DerEncodedX500Principals);

    CARAPI HandshakeCompleted();
...
#endif // __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLSOCKETIMPL_H__
