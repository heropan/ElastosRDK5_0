...
#ifndef __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLSIGNATURE_SHA1RSA_H__
#define __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLSIGNATURE_SHA1RSA_H__

#include "_COpenSSLSignature_SHA1RSA.h"
...
CarClass(COpenSSLSignature_SHA1RSA)
{
public:
    CARAPI GetProvider(
...
#endif // __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLSIGNATURE_SHA1RSA_H__
