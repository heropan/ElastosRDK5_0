...
#ifndef __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLMESSAGEDIGESTJDK_SHA1_H__
#define __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLMESSAGEDIGESTJDK_SHA1_H__

#include "_COpenSSLMessageDigestJDK_SHA1.h"
...
CarClass(COpenSSLMessageDigestJDK_SHA1)
{
public:
    CARAPI Clone(
...
#endif // __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_COPENSSLMESSAGEDIGESTJDK_SHA1_H__
