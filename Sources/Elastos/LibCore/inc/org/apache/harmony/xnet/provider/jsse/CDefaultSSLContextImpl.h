...
#ifndef __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_CDEFAULTSSLCONTEXTIMPL_H__
#define __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_CDEFAULTSSLCONTEXTIMPL_H__
...
#endif // __ORG_APACHE_HARMONY_XNET_PROVIDER_JSSE_CDEFAULTSSLCONTEXTIMPL_H__
