...
#ifndef __ORG_APACHE_HTTP_IMPL_ENTITY_LAXCONTENTLENGTHSTRATEGY_H__
#define __ORG_APACHE_HTTP_IMPL_ENTITY_LAXCONTENTLENGTHSTRATEGY_H__
...
#endif // __ORG_APACHE_HTTP_IMPL_ENTITY_LAXCONTENTLENGTHSTRATEGY_H__
