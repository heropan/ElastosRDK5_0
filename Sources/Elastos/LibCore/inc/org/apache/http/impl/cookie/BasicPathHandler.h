...
#ifndef __ORG_APACHE_HTTP_IMPL_COOKIE_BASICPATHHANDLER_H__
#define __ORG_APACHE_HTTP_IMPL_COOKIE_BASICPATHHANDLER_H__
...
#endif // __ORG_APACHE_HTTP_IMPL_COOKIE_BASICPATHHANDLER_H__
